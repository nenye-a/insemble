            ...
            <Card>
              <CardBody>
                ...
                <Col className="d-flex flex-column justify-content-center">
                  <Row className="py-1" style={{fontWeight: "bold"}}>Map
                  </Row>
                  <Row className="py-1">this is some text about the heat map
                  </Row>
                  <Row className="py-1" style={{fontWeight: "bold"}}>Data
                  </Row>
                  <Row className="py-1">this is some text about how it's generated
                  </Row>
                  <Row className="py-1" style={{fontWeight: "bold"}}>Saving Results
                  </Row>
                  <Row className="py-1">this is some text about how to interact
                  </Row>
                </Col>
