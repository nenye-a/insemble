      ...
      <Container className="main-content-container px-4" fluid>
        ...
        <Row>
          {PostsListOne.map((post, idx) => (
            <Col key={idx} className="mb-4" lg="3" md="6" sm="12">
              <Card className="card-post card-post--1" small tag={NavLink} to="/tenant-deep-dive">
                <div
                  className="card-post__image"
                  style={{ backgroundImage: `url(${post.backgroundImage})` }}
                >
                  <Badge className={`card-post__category bg-${post.categoryTheme}`} pill>
                    {post.category}
                  </Badge>
        ...
        <Row>
          {/* Sessions */}
          <Col className="mb-4" lg="8" md="12" sm="12">
            <Sessions />
          </Col>

          {/* Users by Device */}
          <Col className="mb-4" lg="4" md="6" sm="6">
            <UsersByDevice />
          </Col>
        </Row>

        <Row className="page-header py-4" noGutters>
          <PageTitle className="text-sm-left" sm="4" title="Your Top Categories" />
        </Row>

        <Row>
          {PostsListTwo.map((post, idx) => (
            <Col key={idx} className="mb-4" lg="6" sm="12">
              <Card className="card-post card-post--aside card-post--1" small>
                <div
                  className="card-post__image"
                  style={{ backgroundImage: `url('${post.backgroundImage}')` }}
                >
        ...
        <Row className="page-header py-4" noGutters>
          <PageTitle className="text-sm-left" sm="4" title="Your Customer Journey" />
        </Row>
        ...
        <Row>
          ...
          <Col>
            <Card className="mb-4 overflow-hidden" small>
