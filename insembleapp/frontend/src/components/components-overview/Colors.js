...
//     </Col>
//     <Col className="mb-4">
//       <div className="bg-info rounded p-3" style={{ boxShadow: 'inset 0 0 5px rgba(0,0,0,.2)' }} />
//     </Col>
//     <Col className="mb-4">
//       <div
...
//     </Col>
//     <Col className="mb-4">
//       <div className="bg-dark rounded p-3" style={{ boxShadow: 'inset 0 0 5px rgba(0,0,0,.2)' }} />
//     </Col>
//     <Col className="mb-4">
//       <div
...
//     </Col>
//     <Col className="mb-4">
//       <div className="bg-java rounded p-3" style={{ boxShadow: 'inset 0 0 5px rgba(0,0,0,.2)' }} />
//     </Col>
//   </Row>
// );
