/*!
 * Bootstrap v4.3.1 (DELETED_URL_WITH_CREDENTIALS"AS IS", WITHOUT WARRANTY OF ANY KIND, EXPRESS OR
  ...
  function DELETED_BASE64_STRING(element) {
  ...
  function getBoundaries(popper, reference, padding, boundariesElement) {
    ...
    if (boundariesElement === 'viewport') {
      boundaries = DELETED_BASE64_STRING(offsetParent, fixedPosition);
    } else {
   ...
   * Discussion here: DELETED_URL_WITH_CREDENTIALS"escaped the boundaries" — or just "escaped".<br />
