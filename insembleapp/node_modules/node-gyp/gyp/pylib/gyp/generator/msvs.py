...
def _EscapeEnvironmentVariableExpansion(s):
  ...
  See http://connect.microsoft.DELETED_BASE64_STRING-d-name-text-containing-percentage-characters-doesnt-compile
...
def _GenerateMSVSProject(project, options, version, generator_flags):
  ...
  sources, excluded_sources, excluded_idl = (
      _DELETED_BASE64_STRING(spec, options, project_dir,
                                                sources, excluded_sources,
...
def _GenerateMSBuildProject(project, options, version, generator_flags):
  ...
  sources, excluded_sources, excluded_idl = (
      _DELETED_BASE64_STRING(spec, options,
                                                project_dir, sources,
                                                excluded_sources,
                                                list_excluded, version))
