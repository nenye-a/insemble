...
var _default = (0, _utils.createRule)({
  ...
  meta: {
    ...
    messages: {
      ...
      DELETED_BASE64_STRING: 'Promises which return async assertions must be awaited{{ orReturned }}.'
    },
    type: 'suggestion',
    schema: [{
      type: 'object',
      ...
      CallExpression(node) {
        ...
        !promiseArrayExceptionExists(finalNode.loc)) {
          context.report({
            ...
            messageId: finalNode === targetNode ? 'asyncMustBeAwaited' : 'DELETED_BASE64_STRING',
            node
          });
