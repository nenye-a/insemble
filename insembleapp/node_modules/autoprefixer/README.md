...
.image {
  background-image: url(DELETED_EMAIL);
}
...
<a href="DELETED_URL_WITH_CREDENTIALS"autoplace"`
...
[The guide about Grids in IE and Autoprefixer]: DELETED_URL_WITH_CREDENTIALS"style-loader", "css-loader", "postcss-loader"]
      }
    ]
  }
}
...
[other PostCSS plugins]: DELETED_URL_WITH_CREDENTIALS"no-2009"` value Autoprefixer will add prefixes only
...
[usage statistics]: DELETED_URL_WITH_CREDENTIALS