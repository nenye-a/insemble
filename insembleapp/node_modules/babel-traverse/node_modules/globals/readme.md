...
Extracted from [JSHint](https://github.com/jshint/jshint/blob/DELETED_LONG_HEX_STRING/src/vars.js) and [ESLint](https://github.com/eslint/eslint/blob/DELETED_LONG_HEX_STRING/conf/environments.json) and merged.
