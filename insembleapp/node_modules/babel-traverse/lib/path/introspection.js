...
exports._DELETED_BASE64_STRING = _DELETED_BASE64_STRING;
...
function _guessExecutionStatusRelativeTo(target) {
  ...
  if (targetFuncParent.node !== selfFuncParent.node) {
    var status = this._DELETED_BASE64_STRING(targetFuncParent);
    if (status) {
      return status;
    } else {
...
function _DELETED_BASE64_STRING(targetFuncParent) {
