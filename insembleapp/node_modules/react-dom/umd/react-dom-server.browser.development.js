...

{
  warningWithoutStack = function (condition, format) {
    ...
    if (typeof console !== 'undefined') {
      ...
      // breaks IE9: DELETED_URL_WITH_CREDENTIALS"enumerated" attributes with "true" and "false" as possible values.
...
function isCustomComponent(tagName, props) {
  ...
  switch (tagName) {
    ...
    // DELETED_URL_WITH_CREDENTIALS"%s" or %s={value.toString()}.', value, name, name, value, name);
      } else {
