  ...
  enqueueTask = function (callback) {
    {
      if (didWarnAboutMessageChannel === false) {
        ...
        !(typeof MessageChannel !== 'undefined') ? warningWithoutStack$1(false, 'This browser does not have a MessageChannel implementation, ' + 'so enqueuing tasks via await act(async () => ...) will fail. ' + 'Please file an issue at DELETED_URL_WITH_CREDENTIALS"If you're using TestRenderer for your tests, you should call " + 'ReactTestRenderer.act(...) instead of ReactTestUtils.act(...).') : void 0;
        }
      }
