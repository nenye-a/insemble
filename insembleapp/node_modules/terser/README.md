<h1><img src="DELETED_URL_WITH_CREDENTIALS"@license" or
...
- `safari10` (default `false`) -- Pass `true` to work around the Safari 10 loop
  iterator [bug](DELETED_URL_WITH_CREDENTIALS"@preserve", the comment will be lost because the inner
...
[`TreeWalker`](DELETED_URL_WITH_CREDENTIALS"resolutions": {
...
In the terser CLI we use [source-map-support](DELETED_URL_WITH_CREDENTIALS"https://github.com/terser/terser/graphs/contributors"><img src="https://opencollective.com/terser/contributors.svg?width=890&button=false" /></a>
