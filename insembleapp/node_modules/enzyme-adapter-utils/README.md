...
If you're using React 16.8+ and `.mount()`, Enzyme will wrap apis including [`.simulate()`](https://airbnb.DELETED_BASE64_STRING.html), [`.setProps()`](https://airbnb.DELETED_BASE64_STRING.html), [`.setContext()`](https://airbnb.DELETED_BASE64_STRING.html), [`.invoke()`](https://airbnb.io/enzyme/docs/api/ReactWrapper/invoke.html) with [`ReactTestUtils.act()`](https://reactjs.org/docs/test-utils.html#act) so you don't need to manually wrap it.
