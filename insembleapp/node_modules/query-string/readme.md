...
Strictly encode URI components with [strict-uri-encode](https://github.com/kevva/strict-uri-encode). It uses [encodeURIComponent](https://developer.mozilla.DELETED_BASE64_STRING_Objects/encodeURIComponent)
...
[URL encode](https://developer.mozilla.DELETED_BASE64_STRING_Objects/encodeURIComponent) the keys and values.
