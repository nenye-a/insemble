...

{
  ...
  var expected = 'DELETED_BASE64_STRING' +
...
assert.equal(
  Buffer.from('DELETED_BASE64_STRING', 'base64').length,
  32
);
assert.equal(
  Buffer.from('DELETED_BASE64_STRING', 'base64').length,
...
assert.equal(hexStr,
             'DELETED_CREDIT_CARD08090a0b0c0d0e0f' +
             'DELETED_CREDIT_CARD18191a1b1c1d1e1f' +
             'DELETED_CREDIT_CARD28292a2b2c2d2e2f' +
             'DELETED_CREDIT_CARD38393a3b3c3d3e3f' +
             'DELETED_CREDIT_CARD48494a4b4c4d4e4f' +
             'DELETED_CREDIT_CARD58595a5b5c5d5e5f' +
             'DELETED_CREDIT_CARD68696a6b6c6d6e6f' +
             'DELETED_CREDIT_CARD78797a7b7c7d7e7f' +
             'DELETED_CREDIT_CARD88898a8b8c8d8e8f' +
             'DELETED_CREDIT_CARD98999a9b9c9d9e9f' +
