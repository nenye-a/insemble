...
function shouldUseNative() {
	try {
		...
		// DELETED_URL_WITH_CREDENTIALS"folder/index.js" instead of just "index.js".
...
function defineKeyPropWarningGetter(props, displayName) {
  var warnAboutAccessingKey = function () {
    if (!specialPropKeyWarningShown) {
      ...
      warningWithoutStack$1(false, '%s: `key` is not a prop. Trying to access it will result ' + 'in `undefined` being returned. If you need to access the same ' + 'value within the child component, you should pass it as a different ' + 'prop. (DELETED_URL_WITH_CREDENTIALS"prop", "context", "child context"
