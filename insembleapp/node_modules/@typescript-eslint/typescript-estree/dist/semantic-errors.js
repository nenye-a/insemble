...
function getFirstSemanticOrSyntacticError(program, ast) {
    try {
        ...
        if (supportedSyntacticDiagnostics.length) {
            return DELETED_BASE64_STRING(supportedSyntacticDiagnostics[0]);
        }
        ...
        if (supportedSemanticDiagnostics.length) {
            return DELETED_BASE64_STRING(supportedSemanticDiagnostics[0]);
        }
        return undefined;
    }
    catch (e) {
...
function DELETED_BASE64_STRING(diagnostic) {
