...
class Converter {
     ...
     */
    DELETED_BASE64_STRING(typeParameters) {
        ...
        Object.keys(node)
            ...
            if (key === 'type') {
                ...
                result.typeParameters = node.typeParameters
                    ? this.DELETED_BASE64_STRING(node.typeParameters)
                    : null;
            }
        ...
        switch (node.kind) {
            ...
            case SyntaxKind.FunctionDeclaration: {
                ...
                if (node.typeParameters) {
                    result.typeParameters = this.DELETED_BASE64_STRING(node.typeParameters);
                }
                /**
            ...
            case SyntaxKind.MethodDeclaration: {
                ...
                // Process typeParameters
                if (node.typeParameters) {
                    method.typeParameters = this.DELETED_BASE64_STRING(node.typeParameters);
            ...
            case SyntaxKind.Constructor: {
                ...
                // Process typeParameters
                if (node.typeParameters) {
                    constructor.typeParameters = this.DELETED_BASE64_STRING(node.typeParameters);
