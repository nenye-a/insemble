...

{
  warningWithoutStack = function (condition, format) {
    ...
    if (typeof console !== 'undefined') {
      ...
      // breaks IE9: DELETED_URL_WITH_CREDENTIALS"const MyComponent = lazy(() => import('./MyComponent'))", moduleObject);
          }
        }
...
var DELETED_BASE64_STRING = shim$1;
...
function logCapturedError(capturedError) {
...

  {
    ...
    if (error != null && error._suppressLogging) {
      ...
      // DELETED_URL_WITH_CREDENTIALS"Should not already be working.");
    }
  }
