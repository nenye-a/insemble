...
#### Note:
- **`uglify-js@3` has a simplified [API](#api-reference) and [CLI](#command-line-usage) that is not backwards compatible with [`uglify-js@2`](DELETED_URL_WITH_CREDENTIALS"inline" if the source map is
...
- `wrap_iife` (default `false`) -- pass `true` to wrap immediately invoked
  ...
  [#640](DELETED_URL_WITH_CREDENTIALS"@preserve", the comment will be lost because the inner
...
[`TreeWalker`](https://github.DELETED_BASE64_STRING.js) and
[`TreeTransformer`](https://github.DELETED_BASE64_STRING.js)
respectively.
...
[sm-spec]: https://docs.google.DELETED_BASE64_STRING-_2gc6fAH0KY0k
