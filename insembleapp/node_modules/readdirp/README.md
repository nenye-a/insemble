...
Try more examples by following [instructions](https://github.DELETED_BASE64_STRING.md)
on how to get going.

## tests

The [readdirp tests](https://github.DELETED_BASE64_STRING.js) also will give you a good idea on
how things work.
