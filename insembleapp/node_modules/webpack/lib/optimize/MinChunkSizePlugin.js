...
const schema = require("../..DELETED_BASE64_STRING.json");

/** @typedef {import("../..DELETED_BASE64_STRING").MinChunkSizePluginOptions} MinChunkSizePluginOptions */
		...
		compiler.hooks.compilation.tap("MinChunkSizePlugin", compilation => {
			compilation.hooks.optimizeChunksAdvanced.tap(
				...
				chunks => {
					...
					const DELETED_BASE64_STRING = chunks
					...
					if (DELETED_BASE64_STRING.length === 0) return;

					const pair = DELETED_BASE64_STRING[0];
