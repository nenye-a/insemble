...
const HarmonyImportSideEffectDependency = require("..DELETED_BASE64_STRING");
const HarmonyImportSpecifierDependency = require("..DELETED_BASE64_STRING");
const HarmonyExportSpecifierDependency = require("..DELETED_BASE64_STRING");
const HarmonyExportExpressionDependency = require("..DELETED_BASE64_STRING");
const DELETED_BASE64_STRING = require("..DELETED_BASE64_STRING");
const HarmonyCompatibilityDependency = require("..DELETED_BASE64_STRING");
...
class ConcatenatedModule extends Module {
	...
	source(dependencyTemplates, runtimeTemplate) {
				...
				case "concatenated": {
					...
					for (const dep of info.module.dependencies) {
						if (dep instanceof HarmonyExportSpecifierDependency) {
							...
							dep instanceof DELETED_BASE64_STRING
						) {
		...
		innerDependencyTemplates.set(
			...
			new DELETED_BASE64_STRING(
				dependencyTemplates.get(DELETED_BASE64_STRING),
				this.rootModule,
				moduleToInfoMap
			)
		);
