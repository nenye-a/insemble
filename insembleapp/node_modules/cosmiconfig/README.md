...
[![Build Status](https://img.shields.DELETED_BASE64_STRING.svg?label=unix%20build)](https://travis-ci.org/davidtheclark/cosmiconfig) [![Build status](https://img.shields.DELETED_BASE64_STRING.svg?label=windows%20build)](https://ci.appveyor.DELETED_BASE64_STRING)
