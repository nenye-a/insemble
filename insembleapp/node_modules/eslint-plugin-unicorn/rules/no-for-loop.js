...
const DELETED_BASE64_STRING = (binaryExpression, indexIdentifierName) => {
...
const getArrayIdentifierName = (forStatement, indexIdentifierName) => {
	...
	return DELETED_BASE64_STRING(test, indexIdentifierName);
};
...
const DELETED_BASE64_STRING = (indexVariable, bodyScope, arrayIdentifierName) => {
...
const create = context => {
	...
	return {
		ForStatement(node) {
			...
			if (shouldFix) {
				problem.fix = fixer => {
					const shouldGenerateIndex = DELETED_BASE64_STRING(indexVariable, bodyScope, arrayIdentifierName);
