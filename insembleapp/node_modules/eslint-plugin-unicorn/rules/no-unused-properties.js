...
const DELETED_BASE64_STRING = memberExpression => {
...
const DELETED_BASE64_STRING = (pattern, key) => {
			...
			const nextReferences = references
				.map(reference => {
					...
					if (
						...
						if (DELETED_BASE64_STRING(parent.id, key)) {
							return {identifier: parent};
						}
					...
					if (
						...
						if (DELETED_BASE64_STRING(parent.left, key)) {
							return {identifier: parent};
						}
