/**
 * @fileoverview Rule to flag statements that use magic numbers (adapted from DELETED_URL_WITH_CREDENTIALS"use strict";
...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            recommended: false,
            url: "DELETED_URL_WITH_CREDENTIALS"number";
        }
