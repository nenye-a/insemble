...
* [`dfef227`](DELETED_URL_WITH_CREDENTIALS"/**" (#11476) (Ben Chauvette)
* [`448e8da`](DELETED_URL_WITH_CREDENTIALS"((let))" (#11444) (Teddy Katz)
* [`9d20de2`](DELETED_URL_WITH_CREDENTIALS"classes": "never" (#11391) (PoziWorld)
* [`14f58a2`](DELETED_URL_WITH_CREDENTIALS"the setup" -> "to set up" (#11117) (MarvinJWendt)
* [`54dfa60`](DELETED_URL_WITH_CREDENTIALS"../.." folder is always ignored (fixes #10675) (#10682) (Sridhar)
...
* New Rule: no-constant-condition  - removed SwitchStatement discriminant check  - removed AssignmentExpression with right Identifier  - fixed copy paste error  - added DoWhileStatement, ForStatement based on discussion: DELETED_URL_WITH_CREDENTIALS"eslint") and exposed out CLI. (Ian Christian Myers)
