...
You can also use [istanbul's ignore hints](https://github.DELETED_BASE64_STRING-code-for-coverage.md#ignoring-code-for-coverage-purposes) to specify specific lines of code to skip instrumenting.
