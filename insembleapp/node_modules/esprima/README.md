...
- [Heavily tested](http://esprima.org/test/ci.html) (~1500 [unit tests](https://github.DELETED_BASE64_STRING) with [full code coverage](https://codecov.io/github/jquery/esprima))
