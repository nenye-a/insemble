/*! @sentry/browser 5.6.3 (3060a6e8) | DELETED_URL_WITH_CREDENTIALS"Unknown"] = "unknown";
     ...
     * // borrowed from DELETED_URL_WITH_CREDENTIALS": " + exception.value;
            }
    ...
    function fill(source, name, replacement) {
        ...
        if (typeof wrapped === 'function') {
            try {
                ...
                // Fixes DELETED_URL_WITH_CREDENTIALS"=" + encodeURIComponent(object[key]); })
            .join('&');
    }
    /**
     ...
     * attached to it.
     *
     * Based on: DELETED_URL_WITH_CREDENTIALS"[undefined]"/"[NaN]" respectively,
     ...
     * Jul 11,2018 - #f03357c
     *
     * DELETED_URL_WITH_CREDENTIALS"eval";
                        parts[3] = submatch[1];
                        parts[4] = submatch[2];
         ...
         * @memberof TraceKit._computeStackTrace
         */
        function _DELETED_BASE64_STRING(ex) {
            // TODO: Clean this function up
            // Opera includes a stack trace into the exception message. An example is:
            //
            // Statement on line 3: Undefined variable: undefinedFunc
            // Backtrace:
            //   Line 3 of linked script file:DELETED_BASE64_STRING-client/sample.js: In function zzz
            //         undefinedFunc(a);
            //   Line 7 of inline#1 script in file:DELETED_BASE64_STRING-client/sample.html: In function yyy
            //           zzz(x, y, z);
            //   Line 3 of inline#1 script in file:DELETED_BASE64_STRING-client/sample.html: In function xxx
            //           yyy(a, a, a);
    ...
    var FetchTransport = /** @class */ (function (_super) {
        ...
        FetchTransport.prototype.sendEvent = function (event) {
            var defaultOptions = {
                ...
                method: 'POST',
                // Despite all stars in the sky saying that Edge supports old draft syntax, aka 'never', 'always', 'origin' and 'default
                // DELETED_URL_WITH_CREDENTIALS": " + domException.message : name_1;
    ...
    function wrap(fn, options, before) {
        ...
        // ref: DELETED_URL_WITH_CREDENTIALS"ui." + eventName,
                    message: target,
                }, {
                    event: event,
                    name: eventName,
    ...
    function keypressEventHandler() {
        ...
        return function (event) {
            ...
            try {
                ...
                // see: DELETED_URL_WITH_CREDENTIALS"#" + elem.id);
        }
    ...
    var GlobalHandlers = /** @class */ (function () {
        ...
        GlobalHandlers.prototype._eventFromGlobalHandler = function (stacktrace, error) {
            if (!isString(stacktrace.message) && stacktrace.mechanism !== 'onunhandledrejection') {
                ...
                // DELETED_URL_WITH_CREDENTIALS"Non-Error promise rejection captured with value: " + error,
                        },
                    ],
                };
            }
