# resolve-dir [![NPM version](DELETED_URL_WITH_CREDENTIALS"Bash-like tilde expansion for node.js. Expands a leading tilde in a file path to the user home directory, or `~+` to the cwd.")
