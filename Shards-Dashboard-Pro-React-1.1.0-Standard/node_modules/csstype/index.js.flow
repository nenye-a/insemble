...
export type DELETED_BASE64_STRING<TLength = string | 0> = {
...
export type StandardPropertiesHyphenFallback<TLength = string | 0> = DELETED_BASE64_STRING<TLength> & DELETED_BASE64_STRING<TLength>;
