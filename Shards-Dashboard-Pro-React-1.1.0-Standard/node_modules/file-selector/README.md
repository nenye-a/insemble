...
* [DataTransferItem.getAsFile()](https://developer.mozilla.org/en-DELETED_BASE64_STRING#Browser_compatibility)
* [DataTransferItem.webkitGetAsEntry()](https://developer.mozilla.org/en-DELETED_BASE64_STRING#Browser_compatibility)
* [FileSystemEntry](https://developer.mozilla.org/en-US/docs/Web/API/FileSystemEntry#Browser_compatibility)
* [FileSystemFileEntry.file()](https://developer.mozilla.org/en-DELETED_BASE64_STRING#Browser_compatibility)
* [FileSystemDirectoryEntry.createReader()](https://developer.mozilla.org/en-DELETED_BASE64_STRING#Browser_compatibility)
* [FileSystemDirectoryReader.readEntries()](https://developer.mozilla.org/en-DELETED_BASE64_STRING#Browser_compatibility)
