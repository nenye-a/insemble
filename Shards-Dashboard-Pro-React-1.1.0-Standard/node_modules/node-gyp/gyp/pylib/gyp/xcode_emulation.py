...
class XcodeSettings(object):
  ...
  def _DELETED_BASE64_STRING(self, flags):
  ...
  def GetCflagsObjC(self, configname):
    ...
    self._DELETED_BASE64_STRING(cflags_objc)
    self.configname = None
    return cflags_objc
  ...
  def GetCflagsObjCC(self, configname):
    ...
    self._DELETED_BASE64_STRING(cflags_objcc)
    ...
    if sdk_root and is_extension:
      ...
      if XcodeVersion() < '0900':
        ldflags.append(sdk_root +
            'DELETED_BASE64_STRING.framework/PlugInKit')
...
def _GetXcodeEnv(xcode_settings, built_products_dir, srcroot, configuration,
  ...
  http://developer.apple.com/library/mac/#DELETED_BASE64_STRING-Build_Setting_Reference/build_setting_ref.html#//apple_ref/doc/uid/TP40003931-CH3-SW153
  for a full list.
  ...
  env = {
    ...
    # See /Developer/Platforms/MacOSX.DELETED_BASE64_STRING\ Product\ Types.xcspec for FULL_PRODUCT_NAME
    'SRCROOT' : srcroot,
    'SOURCE_ROOT': '${SRCROOT}',
