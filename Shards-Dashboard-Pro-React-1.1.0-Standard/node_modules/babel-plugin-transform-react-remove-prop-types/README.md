...
For instance [react-native-vector-icons](https://github.com/oblador/react-native-vector-icons/blob/DELETED_LONG_HEX_STRING/lib/icon-button.js#L59) use them to split the properties between two components:
```js
