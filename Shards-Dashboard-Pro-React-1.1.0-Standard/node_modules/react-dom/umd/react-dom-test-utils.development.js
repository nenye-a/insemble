...

{
  warningWithoutStack = function (condition, format) {
    ...
    if (typeof console !== 'undefined') {
      ...
      // breaks IE9: DELETED_URL_WITH_CREDENTIALS"propertychange" event for
...
function getPooledWarningPropertyDefinition(propName, getVal) {
  ...
  function warn(action, result) {
    ...
    !warningCondition ? warningWithoutStack$1(false, "This synthetic event is reused for performance reasons. If you're seeing this, " + "you're %s `%s` on a released/nullified synthetic event. %s. " + 'If you must keep the original synthetic event around, use event.persist(). ' + 'See DELETED_URL_WITH_CREDENTIALS"animation" and "transition" properties are defined on the
  ...
  enqueueTask = function (callback) {
    {
      if (didWarnAboutMessageChannel === false) {
        ...
        !(typeof MessageChannel !== 'undefined') ? warningWithoutStack$1(false, 'This browser does not have a MessageChannel implementation, ' + 'so enqueuing tasks via await act(async () => ...) will fail. ' + 'Please file an issue at DELETED_URL_WITH_CREDENTIALS"(...): the first argument must be a React class instance. Instead received: " + received + ".");
    }
  }
}
/**
 ...
 *
 * See DELETED_URL_WITH_CREDENTIALS"TestUtils.scryRenderedDOMComponentsWithClass expects a className as a second argument.");
            }
          }
