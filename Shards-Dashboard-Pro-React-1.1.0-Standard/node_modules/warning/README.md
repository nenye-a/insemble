...
A mirror of Facebook's [Warning](https://github.DELETED_BASE64_STRING__forks__/warning.js)
...
This is a mirror of Facebook's (FB) [warning](https://github.DELETED_BASE64_STRING__forks__/warning.js) module used within React's source code (and other FB software).
...
The source can be found here: https://github.DELETED_BASE64_STRING__forks__/warning.js
The reasoning can be found here and elsewhere: https://github.com/facebook/fbjs/pull/94#issuecomment-168332326

> Can I add X feature?

This is a mirror of Facebook's (FB) [warning](https://github.DELETED_BASE64_STRING__forks__/warning.js) and as such the source and signature will mirror that module.
