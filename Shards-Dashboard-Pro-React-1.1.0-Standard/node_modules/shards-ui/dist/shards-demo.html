...
<head>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-DELETED_BASE64_STRING"
    crossorigin="anonymous">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="css/shards.min.css?v=2.1.2">
  <link rel="stylesheet" href="css/shards-demo.min.css?v=2.1.2">
</head>
...
<body>
    ...
    <div id="navbars" class="my-5">
      ...
      <div class="example">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary mb-4">
          ...
          <div class="collapse navbar-collapse mr-auto" id="navbarNavDropdown-2">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="https://designrevision.com" id="navbarDropdownMenuLink-2" data-toggle="dropdown"
                  aria-haspopup="true" aria-expanded="false">
                  Services
                </a>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-warning mb-4">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown-4">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="https://designrevision.com" id="navbarDropdownMenuLink-4" data-toggle="dropdown"
                  aria-haspopup="true" aria-expanded="false">
                  Services
                </a>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-danger mb-4">
          ...
          <div class="collapse navbar-collapse mr-auto" id="navbarNavDropdown-5">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="https://designrevision.com" id="navbarDropdownMenuLink-5" data-toggle="dropdown"
                  aria-haspopup="true" aria-expanded="false">
                  Services
                </a>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
          <img src="images/demo/shards-logo-black.svg" alt="Example Navbar 1" class="mr-2" height="30">
          <a class="navbar-brand" href="#">Shards</a>
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown-7">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="https://designrevision.com" id="navbarDropdownMenuLink-7" data-toggle="dropdown"
                  aria-haspopup="true" aria-expanded="false">
                  Services
                </a>
    ...
    <div id="extras" class="mb-5 py-5">
      <div class="section-title container ml-auto mr-auto">
        <div class="col-lg-8 col-md-10 ml-auto mr-auto mb-5">
          ...
          <p class="text-center">That's not all! We've prepared
            <b>two free landing pages</b> built using mostly Shards and some custom styling to help you start your next project
            faster.
          </p>
        </div>
      </div>
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 mb-4 ml-auto">
            <div class="card">
              <img class="card-img-top" src="images/demo/shards-app-demo-page-demo.jpg" alt="Shards App Promo - Demo Landing Page">
          ...
          <div class="col-md-4 mb-4 mr-auto">
            <div class="card">
              <img class="card-img-top" src="images/demo/shards-agency-landing-page-demo.jpg" alt="Shards Agency - Demo Landing Page">
              <div class="card-body py-3">
  ...
  <script>
    (function (d, s, id) {
      ...
      js.id = id;
      js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.10&appId=DELETED_CREDIT_CARD";
  ...
  <script src="https://code.jquery.com/jquery-3.2.1.min.js" integrity="sha256-DELETED_BASE64_STRING"
    crossorigin="anonymous"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-DELETED_BASE64_STRING"
    crossorigin="anonymous"></script>
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-DELETED_BASE64_STRING"
    crossorigin="anonymous"></script>
