...
- A detailed explanation of how to [add a new locale](https://github.com/date-fns/date-DELETED_BASE64_STRING.md#adding-a-new-locale).
...
- Directions on [adding a locale with the same language as another locale](https://github.com/date-fns/date-DELETED_BASE64_STRING.md#creating-a-locale-with-the-same-language-as-another-locale).
