...
/** @typedef {import("../util/deterministicGrouping").GroupedItems<Module>} DELETED_BASE64_STRING */

const deterministicGroupingForModules = /** @type {function(DeterministicGroupingOptionsForModule): DELETED_BASE64_STRING[]} */ (deterministicGrouping);
