...
class DELETED_BASE64_STRING extends HarmonyImportDependency {
	constructor(
		request,
		originModule,
		sourceOrder,
	...
	getMode(ignoreUnused) {
		...
		const activeFromOtherStarExports = this._DELETED_BASE64_STRING();
...
module.exports = DELETED_BASE64_STRING;

DELETED_BASE64_STRING.Template = class DELETED_BASE64_STRING extends HarmonyImportDependency.Template {
	...
	getHarmonyInitOrder(dep) {
		if (dep.name) {
			...
			const activeFromOtherStarExports = dep._DELETED_BASE64_STRING();
