...
# BRANDS -> hosted in appMatchData.brands [a.k.a. DB_BRANDS] (currently called brand_details) # TODO: migrate to brands
'''
...
# PLACES -> hosted in appMatchData.places [a.k.a. DB_PLACES] (currently covered in spaceData.spaces) # TODO: miograte to places
'''
...
Places:
{
    ...
    google_place_id: string,                    -> google place_id of this place if there is one                     
...
# LOCATION MATCHES -> hosted in appMatchData.location_matches [a.k.a. DB_LOCATION_MATCHES] (currently called appMatchData.tenantdetails) # TODO: migrate to matches
'''
...
# PROPERTIES & SPACES -> hosted in appMatchData.properties [a.k.a. DB_PROPERTY] (currently called property_details) # TODO: migrate to properties
'''
...
# BRAND-SPACE MATCHES -> hosted in appMatchData.brand_space_matches [a.k.a. DB_BRAND_SPACE]
'''

Hosts the history of a match between a retailer and a property. Each history will hold the space to retailer match in addition
to the link to the location match that the match is currently hosted under.

Brand-space matches:
{}
'''

# Regions -> hosted in appMatchData.regions [a.k.a. DB_REGIONS]
'''
