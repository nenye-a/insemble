...
import api.pitney as pitney
import api.foursquare as foursquare
import random
...
def place_collector_google(start_lat, start_lng, type_, run_name, bounds, run_record=None):
    ...
    places = google.nearby(start_lat, start_lng, 'restaurant', rankby='distance')
...
def place_collector_google_brute(start_lat, start_lng, type_, run_name, bounds, run_record=None, direction='down'):
    ...
    while collecting:
        ...
        # Query starting point for the nearby google places
        places = google.nearby(start_lat, start_lng,
...
def place_validator(condition=None):
    ...
    while validating:
        ...
        for raw_space in raw_spaces:
            ...
            processed_space = google.find(address, name, bias)
...
def detail_builder():
    ...
    while updating:
        ...
        for space in spaces:
            ...
            google_details = google.details(place_id)
...
def sales_builder(radius=1):
    ...
    while updating:
        ...
        for space in spaces:
            ...
            address = space["formatted_address"]
            print("Original google address", address)
            name = space["name"]
