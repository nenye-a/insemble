...
- Create a copy of ``insembleapp/settings/local.py.example``:
  `cp insembleapp/settings/local.py.example insembleapp/settings/local.py` (remembering you should replace `insembleapp` with your project's name!).
...
## Commercial Support
This project, as other Vinta open-source projects, is used in products of Vinta clients. We are always looking for exciting work, so if you need any commercial support, feel free to get in touch: DELETED_EMAIL
