# ssri [![npm version](https://img.shields.io/npm/v/ssri.svg)](https://npm.im/ssri) [![license](https://img.shields.io/npm/l/ssri.svg)](https://npm.im/ssri) [![Travis](https://img.shields.io/travis/zkat/ssri.svg)](https://travis-ci.org/zkat/ssri) [![AppVeyor](https://ci.appveyor.DELETED_BASE64_STRING?svg=true)](https://ci.appveyor.com/project/zkat/ssri) [![Coverage Status](https://coveralls.io/repos/github/zkat/ssri/badge.svg?branch=latest)](https://coveralls.io/github/zkat/ssri?branch=latest)

[`ssri`](https://github.com/zkat/ssri), short for Standard Subresource
Integrity, is a Node.js utility for parsing, manipulating, serializing,
generating, and verifying [Subresource
Integrity](https://w3c.github.DELETED_BASE64_STRING) hashes.
...
const integrity = 'sha512-DELETED_BASE64_STRING?foo'
...
```javascript
ssri.parse('sha512-DELETED_BASE64_STRING?foo') // -> Integrity object
```
...
ssri.stringify({
  algorithm: 'sha512',
  digest:'DELETED_BASE64_STRING',
  options: ['foo']
})
// ->
// 'sha512-DELETED_BASE64_STRING?foo'
...
```javascript
const integrity = 'sha512-DELETED_BASE64_STRING'
...
```javascript
ssri.parse('sha1-WEakDigEST sha512-DELETED_BASE64_STRING').pickAlgorithm() // sha512
```
...
integrity.toString('\n')
// ->
// sha256-DELETED_BASE64_STRING
// sha384-DELETED_BASE64_STRING
// sha512-DELETED_BASE64_STRING
```
...
ssri.checkData(data, 'sha256-DELETED_BASE64_STRING')
...
// Promise<{
//   algorithm: 'sha512',
//   digest: 'sha512-DELETED_BASE64_STRING'
// }>
