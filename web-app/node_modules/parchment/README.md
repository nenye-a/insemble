...
The implementation for Attributors is surprisingly simple, and its [source code](https://github.DELETED_BASE64_STRING) may be another source of understanding.
