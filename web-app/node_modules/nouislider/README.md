...
If you're using ES6 imports, a simple [import with side effect](https://developer.mozilla.org/en-DELETED_BASE64_STRING#Import_a_module_for_its_side_effects_only)
is enough:
