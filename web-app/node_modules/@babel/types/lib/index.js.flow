...
declare class DELETED_BASE64_STRING extends BabelNode {
...
type BabelNodeTSTypeElement = BabelNodeTSCallSignatureDeclaration | DELETED_BASE64_STRING | BabelNodeTSPropertySignature | BabelNodeTSMethodSignature | BabelNodeTSIndexSignature;
...
declare module "@babel/types" {
  ...
  declare function tsConstructSignatureDeclaration(typeParameters?: BabelNodeTSTypeParameterDeclaration, parameters: Array<BabelNodeIdentifier | BabelNodeRestElement>, typeAnnotation?: BabelNodeTSTypeAnnotation): DELETED_BASE64_STRING;
  ...
  declare function isTSConstructSignatureDeclaration(node: ?Object, opts?: ?Object): boolean %checks (node instanceof DELETED_BASE64_STRING)
