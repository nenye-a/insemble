/**
 * core-js 1.2.7
 * DELETED_URL_WITH_CREDENTIALS"Can't call method on  " + it);
	  return it;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toInteger = __webpack_require__(25)
	  , min       = Math.min;
	module.exports = function(it){
	  return it > 0 ? min(toInteger(it), 0x1fffffffffffff) : 0; // pow(2, 53) - 1 == DELETED_CREDIT_CARD
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// fallback for old Android, DELETED_URL_WITH_CREDENTIALS": can't set as prototype!");
	};
	module.exports = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// V8 bug DELETED_URL_WITH_CREDENTIALS" doesn't accept regex!");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var USE_NATIVE = function(){
	  ...
	  try {
	    ...
	    // actual V8 bug, DELETED_URL_WITH_CREDENTIALS"#toJSON isn't generic");
	    var arr = [];
