<p align="center">
  <img src="DELETED_URL_WITH_CREDENTIALS"name": "your cool library",
  "version": "1.1.2",
  "bundlesize": [
    {
      "path": "./dist.js",
...
![build status](https://cdn.rawgit.DELETED_BASE64_STRING.png)
...
- [Authorize `bundlesize` for status access](https://github.com/login/oauth/authorize?scope=repo%3Astatus&client_id=<CLIENT_ID> copy the token provided.
...
<a href="https://www.youtube.com/watch?v=_srJ7eHS3IM">
  <img height="200px" src="https://cdn.rawgit.DELETED_BASE64_STRING.png"/>
</a>
