<div style="text-align:center;">
  <a href="DELETED_URL_WITH_CREDENTIALS" target="\_parent">"Why I wrote React Table and the problems it has solved for Nozzle.io"</a> by Tanner Linsley

## CodeSandbox Examples

- [100k-rows-aggregation](DELETED_URL_WITH_CREDENTIALS"center" valign="middle">
        <a href="DELETED_URL_WITH_CREDENTIALS"stylesheet" href="node_modules/react-table/react-table.css">
```
...
<link
  rel="stylesheet"
  href="DELETED_URL_WITH_CREDENTIALS"
/>
...
![With Header Columns](https://raw.githubusercontent.DELETED_BASE64_STRING-table%20foldableHOC/FoldableTable%20With%20Header.gif)
...
![With Normal Columns](https://raw.githubusercontent.DELETED_BASE64_STRING-table%20foldableHOC/FoldableTable%20Without%20Header.gif)

- The `FoldableTable` also fully compatible with existing HOCs, below is with selectTableHOC.

![With Normal Columns](https://raw.githubusercontent.DELETED_BASE64_STRING-table%20foldableHOC/FoldableTable%20With%20selectTable.gif)
