...
[![Coverage Status](https://img.shields.DELETED_BASE64_STRING.svg)](https://codecov.io/github/jquery/esprima)
...
- [Heavily tested](http://esprima.org/test/ci.html) (~1300 [unit tests](https://github.DELETED_BASE64_STRING) with [full code coverage](https://codecov.io/github/jquery/esprima))
