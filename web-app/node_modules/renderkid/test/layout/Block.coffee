...
describe "Layout", ->
  describe "inline inputs", ->
    ...
    it "should be correctly wrapped", ->
      ...
      block.write 'DELETED_CREDIT_CARD78901234567890'
      block.close()
      get(l).should.equal 'DELETED_CREDIT_CARD7890\n1234567890'

    it "should trim from left when wrapping to a new line", ->
      l = new Layout
      block = l.openBlock conf width: 20
      block.write 'DELETED_CREDIT_CARD7890 \t DELETED_CREDIT_CARD78901'
      block.close()
      get(l).should.equal 'DELETED_CREDIT_CARD7890\nDELETED_CREDIT_CARD7890\n1'
    ...
    it "should not put extra line breaks when a line is already broken", ->
      l = new Layout
      block = l.openBlock conf width: 20
      block.write 'DELETED_CREDIT_CARD6789\n0123456789'
      block.close()
      get(l).should.equal 'DELETED_CREDIT_CARD6789\n0123456789'
  ...
  describe "horizontal margins", ->
    ...
    it "should break lines according to terminal width", ->
      ...
      # Note: We don't expect ' DELETED_CREDIT_CARD6  \n 789  ',
      # since the first line (' DELETED_CREDIT_CARD6  ') is a full line
      # according to layout.config.terminalWidth and doesn't need
      # a break line.
      get(l).should.equal ' DELETED_CREDIT_CARD6   789  '
  ...
  describe "blocks and blocks", ->
    it "should not get extra break lines for full-width lines", ->
      l = new Layout
      l.openBlock(conf width: 20).write('DELETED_CREDIT_CARD6789').close()
      l.openBlock().write('b').close()
      get(l).should.equal 'DELETED_CREDIT_CARD6789\nb'

    it "should not get extra break lines for full-width lines followed by a margin", ->
      l = new Layout
      l.openBlock(conf width: 20, bottom: 1).write('DELETED_CREDIT_CARD6789').close()
      l.openBlock().write('b').close()
      get(l).should.equal 'DELETED_CREDIT_CARD6789\n\nb'
