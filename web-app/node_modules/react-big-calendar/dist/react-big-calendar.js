(function (global, factory) {
  ...
  */
  ...
  var MAX_SAFE_INTEGER = DELETED_CREDIT_CARD;
  ...
  /** Used as references for various `Number` constants. */
  var MAX_SAFE_INTEGER$1 = DELETED_CREDIT_CARD;
  ...
  /** Used as references for various `Number` constants. */
  var INFINITY = 1 / 0,
      MAX_INTEGER = 1.DELETED_CREDIT_CARDe+308;
  ...
  function () {
    function Selection(node, _temp) {
      ...
      // DELETED_URL_WITH_CREDENTIALS"top", "left", "offsetWidth" and "offsetHeight"
  ...
  function baseIteratee(value) {
    ...
    // See DELETED_URL_WITH_CREDENTIALS"div", {
        className: "rbc-row"
      }, row);
    };
  ...
  function compareMultiple(object, other, orders) {
    ...
    // `object` and `other`. See DELETED_URL_WITH_CREDENTIALS"_width",
      get: function get() {
