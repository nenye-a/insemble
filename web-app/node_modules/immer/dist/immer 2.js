...
function is(x, y) {
    // From: DELETED_URL_WITH_CREDENTIALS"length")) descriptor.configurable = true;
    return descriptor;
}
...
function shallowEqual(objA, objB) {
    //From: DELETED_URL_WITH_CREDENTIALS"produce expects 1 to 3 arguments, got " + arguments.length);
