...
describe('utils', function() {
  ...
  describe('r28shl', function() {
    it('should shl properly', function() {
      assert.equal(utils.r28shl(bin('DELETED_CREDIT_CARD101010101111'), 1),
                   bin('DELETED_CREDIT_CARD010101011111'));

      assert.equal(utils.r28shl(bin('DELETED_CREDIT_CARD011110001111'), 1),
                   bin('DELETED_CREDIT_CARD111100011110'));

      assert.equal(utils.r28shl(bin('DELETED_CREDIT_CARD101010101111'), 4),
                   bin('DELETED_CREDIT_CARD101011111111'));

      assert.equal(utils.r28shl(bin('DELETED_CREDIT_CARD011110001111'), 4),
                   bin('DELETED_CREDIT_CARD100011110101'));
    });
  });
