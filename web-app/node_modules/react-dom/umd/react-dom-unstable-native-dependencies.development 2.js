...
function DELETED_BASE64_STRING(event) {
  if (event && event.dispatchConfig.phasedRegistrationNames) {
...
function accumulateTwoPhaseDispatchesSkipTarget(events) {
  forEachAccumulated(events, DELETED_BASE64_STRING);
}
...
function getPooledWarningPropertyDefinition(propName, getVal) {
  ...
  function warn(action, result) {
    ...
    !warningCondition ? warningWithoutStack$1(false, "This synthetic event is reused for performance reasons. If you're seeing this, " + "you're %s `%s` on a released/nullified synthetic event. %s. " + 'If you must keep the original synthetic event around, use event.persist(). ' + 'See DELETED_URL_WITH_CREDENTIALS"accumulate(...): Accumulated items must not be null or undefined.");
    }
  }
...
var eventTypes = {
  ...
  selectionChangeShouldSetResponder: {
    phasedRegistrationNames: {
      ...
      captured: 'DELETED_BASE64_STRING'
    },
