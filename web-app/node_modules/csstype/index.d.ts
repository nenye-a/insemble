export interface StandardLonghandProperties<TLength = string | 0> {
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"pass over" possible snap positions.
   *
   * **Initial value**: `normal`
   *
   * | Chrome | Firefox | Safari | Edge | IE  |
   ...
   * | **75** |   No    |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"" (the empty string)
   */
...
export interface StandardLonghandPropertiesHyphen<TLength = string | 0> {
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"align-items"?: AlignItemsProperty;
  /**
   * The **`align-self`** CSS property aligns flex items of the current flex line overriding the `align-items` value. If any of the item's cross-axis margin is set to `auto`, then `align-self` is ignored. In Grid layout `align-self` aligns the item inside the grid area.
   *
   * **Initial value**: `auto`
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"animation-delay"?: GlobalsString;
  /**
   * The **`animation-direction`** CSS property sets whether an animation should play forwards, backwards, or alternating back and forth.
   *
   * **Initial value**: `normal`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"animation-duration"?: GlobalsString;
  /**
   * The **`animation-fill-mode`** CSS property sets how a CSS animation applies styles to its target before and after its execution.
   *
   * **Initial value**: `none`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"animation-iteration-count"?: AnimationIterationCountProperty;
  /**
   * The **`animation-name`** CSS property sets one or more animations to apply to an element. Each name is an `@keyframes` at-rule that sets the property values for the animation sequence.
   *
   * **Initial value**: `none`
   ...
   * | 3 _-x-_ | 5 _-x-_ | 4 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"animation-play-state"?: AnimationPlayStateProperty;
  /**
   * The `**animation-timing-function**` CSS property sets how an animation progresses through the duration of each cycle.
   *
   * **Initial value**: `ease`
   ...
   * | 3 _-x-_ | 5 _-x-_ | 4 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"backdrop-filter"?: BackdropFilterProperty;
  /**
   * The **`backface-visibility`** CSS property sets whether the back face of an element is visible when turned towards the user.
   *
   * **Initial value**: `visible`
   ...
   * | 12 _-x-_ | 10 _-x-_ |               |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"background-attachment"?: BackgroundAttachmentProperty;
  /**
   ...
   * | **35** | **30**  | **8**  |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"background-clip"?: BackgroundClipProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"background-image"?: BackgroundImageProperty;
  /**
   * The **`background-origin`** CSS property sets the _background positioning area_. In other words, it sets the origin position of an image set with the `background-image` property.
   *
   * **Initial value**: `padding-box`
   ...
   * | **1**  |  **4**  | **3**  | **12** | **9** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"background-position"?: BackgroundPositionProperty<TLength>;
  /**
   ...
   * | **1**  | **49**  | **1**  | **12** | **6** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"background-position-y"?: BackgroundPositionYProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"background-size"?: BackgroundSizeProperty<TLength>;
  /** **Initial value**: `clip` */
   ...
   * | **57** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block-color"?: BorderBlockColorProperty;
  /**
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block-end-style"?: BorderBlockEndStyleProperty;
  /**
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block-start-color"?: BorderBlockStartColorProperty;
  /**
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block-start-width"?: BorderBlockStartWidthProperty<TLength>;
  /**
   ...
   * | **69** | **66**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block-width"?: BorderBlockWidthProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-bottom-left-radius"?: BorderBottomLeftRadiusProperty<TLength>;
  /**
   * The **`border-bottom-right-radius`** CSS property rounds the bottom-right corner of an element.
   *
   * **Initial value**: `0`
   ...
   * | 1 _-x-_ |         | 3 _-x-_ |        |       |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-bottom-style"?: BorderBottomStyleProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-collapse"?: BorderCollapseProperty;
  /**
   ...
   * |   No   | **66**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-end-start-radius"?: BorderEndStartRadiusProperty<TLength>;
  /**
   ...
   * | **15** | **15**  | **6**  | **12** | **11** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-image-repeat"?: BorderImageRepeatProperty;
  /**
   * The **`border-image-slice`** CSS property divides the image specified by `border-image-source` into regions. These regions form the components of an element's border image.
   *
   * **Initial value**: `100%`
   ...
   * | **15** | **15**  | **6**  | **12** | **11** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-image-source"?: BorderImageSourceProperty;
  /**
   ...
   * | **15** | **13**  | **6**  | **12** | **11** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline-color"?: BorderInlineColorProperty;
  /**
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline-end-style"?: BorderInlineEndStyleProperty;
  /**
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline-start-color"?: BorderInlineStartColorProperty;
  /**
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline-start-width"?: BorderInlineStartWidthProperty<TLength>;
  /**
   ...
   * | **69** | **66**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline-width"?: BorderInlineWidthProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-left-style"?: BorderLeftStyleProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-right-color"?: BorderRightColorProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-right-width"?: BorderRightWidthProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **8** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-start-end-radius"?: BorderStartEndRadiusProperty<TLength>;
  /**
   ...
   * |   No   | **66**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-top-color"?: BorderTopColorProperty;
  /**
   * The **`border-top-left-radius`** CSS property rounds the top-left corner of an element.
   *
   * **Initial value**: `0`
   ...
   * | 1 _-x-_ |         | 3 _-x-_ |        |       |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-top-right-radius"?: BorderTopRightRadiusProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-top-width"?: BorderTopWidthProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"box-decoration-break"?: BoxDecorationBreakProperty;
  /**
   * The **`box-shadow`** CSS property adds shadow effects around an element's frame. You can set multiple effects separated by commas. A box shadow is described by X and Y offsets relative to the element, blur and spread radii, and color.
   *
   * **Initial value**: `none`
   ...
   * | 1 _-x-_ |         | 3 _-x-_ |        |       |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"box-sizing"?: BoxSizingProperty;
  /**
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"break-before"?: BreakBeforeProperty;
  /**
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"caption-side"?: CaptionSideProperty;
  /**
   ...
   * | **57** | **53**  | **11.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"clip-path"?: ClipPathProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **3** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"color-adjust"?: ColorAdjustProperty;
  /**
   * The **`column-count`** CSS property breaks an element's content into the specified number of columns.
   *
   * **Initial value**: `auto`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"column-fill"?: ColumnFillProperty;
  /**
   * The **`column-gap`** CSS property sets the size of the gap (gutter) between an element's columns.
   *
   * **Initial value**: `normal`
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"column-rule-color"?: ColumnRuleColorProperty;
  /**
   * The **`column-rule-style`** CSS property sets the style of the line drawn between columns in a multi-column layout.
   *
   * **Initial value**: `none`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"column-rule-width"?: ColumnRuleWidthProperty<TLength>;
  /**
   * The **`column-span`** CSS property makes it possible for an element to span across all columns when its value is set to `all`.
   *
   * **Initial value**: `none`
   ...
   * | 6 _-x-_ |         | 5.1 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"column-width"?: ColumnWidthProperty<TLength>;
  /**
   ...
   * | **52** | **69**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"counter-increment"?: CounterIncrementProperty;
  /**
   ...
   * | **2**  |  **1**  | **3**  | **12** | **8** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"counter-set"?: CounterSetProperty;
  /**
   ...
   * | **1**  |  **1**  | **1.2** | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"empty-cells"?: EmptyCellsProperty;
  /**
   * The **`filter`** CSS property applies graphical effects like blur or color shift to an element. Filters are commonly used to adjust the rendering of images, backgrounds, and borders.
   *
   * **Initial value**: `none`
   ...
   * | 18 _-x-_ |         | 6 _-x-_ |        |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"flex-basis"?: FlexBasisProperty<TLength>;
  /**
   * The **`flex-direction`** CSS property sets how flex items are placed in the flex container defining the main axis and the direction (normal or reversed).
   *
   * **Initial value**: `row`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"flex-grow"?: GlobalsNumber;
  /**
   * The **`flex-shrink`** CSS property sets the flex shrink factor of a flex item. If the size of flex items is larger than the flex container, items shrink to fit according to `flex-shrink`.
   *
   * **Initial value**: `1`
   ...
   * | 21 _-x-_ |         | 8 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"flex-wrap"?: FlexWrapProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-family"?: FontFamilyProperty;
  /**
   * The **`font-feature-settings`** CSS property controls advanced typographic features in OpenType fonts.
   *
   * **Initial value**: `normal`
   ...
   * | 16 _-x-_ | 15 _-x-_ |         |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-kerning"?: FontKerningProperty;
  /**
   ...
   * |        | 4 _-x-_ |        |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-optical-sizing"?: FontOpticalSizingProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-size-adjust"?: FontSizeAdjustProperty;
  /**
   ...
   * | **60** |  **9**  | **11** | **12** | **9** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-style"?: FontStyleProperty;
  /**
   ...
   * |   No   | **34**  | **9**  |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-variant"?: FontVariantProperty;
  /**
   ...
   * | **52** | **34**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-variant-east-asian"?: FontVariantEastAsianProperty;
  /**
   * The **`font-variant-ligatures`** CSS property controls which ligatures and contextual forms are used in textual content of the elements it applies to. This leads to more harmonized forms in the resulting text.
   *
   * **Initial value**: `normal`
   ...
   * | 31 _-x-_ |         | 7 _-x-_ |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-variant-numeric"?: FontVariantNumericProperty;
  /**
   ...
   * |   No   | **34**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-variation-settings"?: FontVariationSettingsProperty;
  /**
   ...
   * | **2**  |  **1**  | **1**  | **12** | **3** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-auto-columns"?: GridAutoColumnsProperty<TLength>;
  /**
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-auto-rows"?: GridAutoRowsProperty<TLength>;
  /**
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-column-start"?: GridColumnStartProperty;
  /**
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-row-start"?: GridRowStartProperty;
  /**
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-template-columns"?: GridTemplateColumnsProperty<TLength>;
  /**
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"hanging-punctuation"?: HangingPunctuationProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"image-orientation"?: ImageOrientationProperty;
  /**
   ...
   * | **13** | **3.6** | **6**  |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"initial-letter"?: InitialLetterProperty;
  /**
   ...
   * | **57** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"inset-block"?: InsetBlockProperty<TLength>;
  /**
   * The **`inset-block-end`** CSS property defines the logical block end offset of an element, which maps to a physical inset depending on the element's writing mode, directionality, and text orientation. It corresponds to the `top`, `right`, `bottom`, or `left` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `auto`
   ...
   * |  n/a   | **63**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"inset-block-start"?: InsetBlockStartProperty<TLength>;
  /**
   * The **`inset-inline`** CSS property defines the logical block start and end offsets of an element, which maps to physical offsets depending on the element's writing mode, directionality, and text orientation. It corresponds to the `top` and `bottom`, or `right` and `left` properties depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `auto`
   ...
   * |  n/a   | **63**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"inset-inline-end"?: InsetInlineEndProperty<TLength>;
  /**
   * The **`inset-inline-start`** CSS property defines the logical inline start inset of an element, which maps to a physical offset depending on the element's writing mode, directionality, and text orientation. It corresponds to the `top`, `right`, `bottom`, or `left` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `auto`
   ...
   * |  n/a   | **63**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"justify-content"?: JustifyContentProperty;
  /**
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"justify-self"?: JustifySelfProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"letter-spacing"?: LetterSpacingProperty<TLength>;
  /**
   * The **`line-break`** CSS property sets how to break lines of Chinese, Japanese, or Korean (CJK) text when working with punctuation and symbols.
   *
   * **Initial value**: `auto`
   ...
   * | 1 _-x-_ |         |             |        |         |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"line-height"?: LineHeightProperty<TLength>;
  /**
   ...
   * |  n/a   |   No    |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"list-style-image"?: ListStyleImageProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"list-style-type"?: ListStyleTypeProperty;
  /**
   ...
   * | **69** | **66**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"margin-block-end"?: MarginBlockEndProperty<TLength>;
  /**
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"margin-bottom"?: MarginBottomProperty<TLength>;
  /**
   ...
   * | **69** | **66**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"margin-inline-end"?: MarginInlineEndProperty<TLength>;
  /**
   * The **`margin-inline-start`** CSS property defines the logical inline start margin of an element, which maps to a physical margin depending on the element's writing mode, directionality, and text orientation. It corresponds to the `margin-top`, `margin-right`, `margin-bottom`, or `margin-left` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `0`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"margin-left"?: MarginLeftProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **3** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"margin-top"?: MarginTopProperty<TLength>;
  /**
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"mask-composite"?: MaskCompositeProperty;
  /**
   * The **`mask-image`** CSS property sets the image that is used as mask layer for an element.
   *
   * **Initial value**: `none`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"mask-mode"?: MaskModeProperty;
  /**
   * The **`mask-origin`** CSS property sets the origin of a mask.
   *
   * **Initial value**: `border-box`
   ...
   * | **1** _-x-_ | **53**  | **4** _-x-_ |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"mask-position"?: MaskPositionProperty<TLength>;
  /**
   * The **`mask-repeat`** CSS property sets how mask images are repeated. A mask image can be repeated along the horizontal axis, the vertical axis, both axes, or not repeated at all.
   *
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"mask-size"?: MaskSizeProperty<TLength>;
  /**
   ...
   * | **24** | **35**  | **6.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"max-block-size"?: MaxBlockSizeProperty<TLength>;
  /**
   ...
   * | **18** |  **1**  | **1.3** | **12** | **7** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"max-inline-size"?: MaxInlineSizeProperty<TLength>;
  /** **Initial value**: `none` */
   ...
   * | **1**  |  **1**  | **1**  | **12** | **7** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"min-block-size"?: MinBlockSizeProperty<TLength>;
  /**
   ...
   * | **1**  |  **3**  | **1.3** | **12** | **7** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"min-inline-size"?: MinInlineSizeProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **7** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"mix-blend-mode"?: MixBlendModeProperty;
  /**
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"motion-path"?: OffsetPathProperty;
  /**
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"object-fit"?: ObjectFitProperty;
  /**
   * The **`object-position`** CSS property specifies the alignment of the selected replaced element's contents within the element's box. Areas of the box which aren't covered by the replaced element's object will show the element's background.
   *
   * **Initial value**: `50% 50%`
   ...
   * | **31** | **36**  | **10** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"offset-anchor"?: OffsetAnchorProperty<TLength>;
  /**
   * The **`offset-distance`** CSS property specifies a position along an `offset-path`.
   *
   * **Initial value**: `0`
   ...
   * | 46 _(motion-distance)_ |         |        |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"offset-path"?: OffsetPathProperty;
  /** **Initial value**: `auto` */
   ...
   * | 46 _(motion-rotation)_ |         |        |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"offset-rotation"?: OffsetRotateProperty;
  /**
   * The **`opacity`** CSS property sets the transparency of an element or the degree to which content behind an element is visible.
   *
   * **Initial value**: `1.0`
   ...
   * | **1**  |  **1**  | **2**  | **12** | **9** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"outline-color"?: OutlineColorProperty;
  /**
   ...
   * | **1**  | **1.5** | **1.2** | **15** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"outline-style"?: OutlineStyleProperty;
  /**
   * The **`outline-width`** CSS property sets the thickness of an element's outline. An outline is a line that is drawn around an element, outside the `border`.
   *
   * **Initial value**: `medium`
   ...
   * | **1**  | **1.5** | **1.2** | **12** | **8** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"overflow-anchor"?: OverflowAnchorProperty;
  /**
   * **Initial value**: `auto`
   *
   * | Chrome | Firefox | Safari | Edge | IE  |
   ...
   * |   No   | **69**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"overflow-clip-box"?: OverflowClipBoxProperty;
  /**
   * **Initial value**: `auto`
   *
   * | Chrome | Firefox | Safari | Edge | IE  |
   ...
   * |   No   | **69**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"overflow-wrap"?: OverflowWrapProperty;
  /**
   * The **`overflow-x`** CSS property sets what shows when content overflows a block-level element's left and right edges. This may be nothing, a scroll bar, or the overflow content.
   *
   * **Initial value**: `visible`
   ...
   * | **1**  | **3.5** | **3**  | **12** | **5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"overflow-y"?: OverflowYProperty;
  /**
   ...
   * | **63** | **59**  |   No   | **18** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"overscroll-behavior-x"?: OverscrollBehaviorXProperty;
  /**
   ...
   * | **63** | **59**  |   No   | **18** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"padding-block"?: PaddingBlockProperty<TLength>;
  /**
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"padding-block-start"?: PaddingBlockStartProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"padding-inline"?: PaddingInlineProperty<TLength>;
  /**
   * The **`padding-inline-end`** CSS property defines the logical inline end padding of an element, which maps to a physical padding depending on the element's writing mode, directionality, and text orientation. It corresponds to the `padding-top`, `padding-right`, `padding-bottom`, or `padding-left` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `0`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"padding-inline-start"?: PaddingInlineStartProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"padding-right"?: PaddingRightProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"page-break-after"?: PageBreakAfterProperty;
  /**
   ...
   * | **1**  |  **1**  | **1.2** | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"page-break-inside"?: PageBreakInsideProperty;
  /**
   ...
   * | **35** | **60**  | **8**  | **17** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"perspective-origin"?: PerspectiveOriginProperty<TLength>;
  /**
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"pointer-events"?: PointerEventsProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"row-gap"?: RowGapProperty<TLength>;
  /**
   ...
   * |   No   | **38**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"ruby-position"?: RubyPositionProperty;
  /**
   ...
   * |   No   |   n/a   |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-behavior"?: ScrollBehaviorProperty;
  /**
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-margin-block"?: ScrollMarginBlockProperty<TLength>;
  /**
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-margin-block-start"?: ScrollMarginBlockStartProperty<TLength>;
  /**
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-margin-inline"?: ScrollMarginInlineProperty<TLength>;
  /**
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-margin-inline-start"?: ScrollMarginInlineStartProperty<TLength>;
  /**
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-margin-right"?: ScrollMarginRightProperty<TLength>;
  /**
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-padding"?: ScrollPaddingProperty<TLength>;
  /**
 ...
 * | **69** | **68**  |   No   |  No  | No  |
 * 
 * @see DELETED_URL_WITH_CREDENTIALS"scroll-padding-block-end"?: ScrollPaddingBlockEndProperty<TLength>;
  /**
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-padding-bottom"?: ScrollPaddingBottomProperty<TLength>;
  /**
 ...
 * | **69** | **68**  |   No   |  No  | No  |
 * 
 * @see DELETED_URL_WITH_CREDENTIALS"scroll-padding-inline-end"?: ScrollPaddingInlineEndProperty<TLength>;
  /**
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-padding-left"?: ScrollPaddingLeftProperty<TLength>;
  /**
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-padding-top"?: ScrollPaddingTopProperty<TLength>;
  /**
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-snap-stop"?: ScrollSnapStopProperty;
  /**
   * The **`scroll-snap-type`** CSS property sets how strictly snap points are enforced on the scroll container in case there is one.
   *
   * **Initial value**: `none`
   ...
   * |        |         | 9 _-x-_ |              |              |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scrollbar-color"?: ScrollbarColorProperty;
  /**
   ...
   * |   No   | **64**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"shape-image-threshold"?: ShapeImageThresholdProperty;
  /**
   * The **`shape-margin`** CSS property sets a margin for a CSS shape created using `shape-outside`.
   *
   * **Initial value**: `0`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"shape-outside"?: ShapeOutsideProperty;
  /**
   * The **`tab-size`** CSS property is used to customize the width of a tab (`U+0009`) character.
   *
   * **Initial value**: `8`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"table-layout"?: TableLayoutProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **3** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-align-last"?: TextAlignLastProperty;
  /**
   * The **`text-combine-upright`** CSS property sets the combination of characters into the space of a single character. If the combined text is wider than 1em, the user agent must fit the contents within 1em. The resulting composition is treated as a single upright glyph for layout and decoration. This property only has an effect in vertical writing modes.
   *
   * **Initial value**: `none`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-decoration-color"?: TextDecorationColorProperty;
  /**
   * The **`text-decoration-line`** CSS property sets the kind of decoration that is used on text in an element, such as an underline or overline.
   *
   * **Initial value**: `none`
   ...
   * |        |         | 8 _-x-_  |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-decoration-skip"?: TextDecorationSkipProperty;
  /**
   ...
   * | **64** | **70**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-decoration-style"?: TextDecorationStyleProperty;
  /**
   ...
   * |   No   | **70**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-decoration-width"?: TextDecorationThicknessProperty<TLength>;
  /**
   * The **`text-emphasis-color`** CSS property sets the color of emphasis marks. This value can also be set using the `text-emphasis` shorthand.
   *
   * **Initial value**: `currentcolor`
   ...
   * | **25** | **46**  | **6.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-emphasis-position"?: GlobalsString;
  /**
   * The **`text-emphasis-style`** CSS property sets the appearance of emphasis marks. It can also be set, and reset, using the `text-emphasis` shorthand.
   *
   * **Initial value**: `none`
   ...
   * | **25** | **46**  | **6.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-indent"?: TextIndentProperty<TLength>;
  /**
   ...
   * |  n/a   | **55**  |   No   | **12** | **11** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-orientation"?: TextOrientationProperty;
  /**
   * The **`text-overflow`** CSS property sets how hidden overflow content is signaled to users. It can be clipped, display an ellipsis ('`…`'), or display a custom string.
   *
   * **Initial value**: `clip`
   ...
   * | **1**  |  **7**  | **1.3** | **12** | **6** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-rendering"?: TextRenderingProperty;
  /**
   ...
   * | **2**  | **3.5** | **1.1** | **12** | **10** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-size-adjust"?: TextSizeAdjustProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-underline-offset"?: TextUnderlineOffsetProperty<TLength>;
  /**
   ...
   * | **33** |   No    |   No   | **12** | **6** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"touch-action"?: TouchActionProperty;
  /**
   * The **`transform`** CSS property lets you rotate, scale, skew, or translate an element. It modifies the coordinate space of the CSS visual formatting model.
   *
   * **Initial value**: `none`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"transform-box"?: TransformBoxProperty;
  /**
   * The **`transform-origin`** CSS property sets the origin for an element's transformations.
   *
   * **Initial value**: `50% 50% 0`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"transform-style"?: TransformStyleProperty;
  /**
   * The **`transition-delay`** CSS property specifies the duration to wait before starting a property's transition effect when its value changes.
   *
   * **Initial value**: `0s`
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"transition-duration"?: GlobalsString;
  /**
   * The **`transition-property`** CSS property sets the CSS properties to which a transition effect should be applied.
   *
   * **Initial value**: all
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"transition-timing-function"?: TransitionTimingFunctionProperty;
  /**
   ...
   * |   No   |   n/a   |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"unicode-bidi"?: UnicodeBidiProperty;
  /**
   * The `**user-select**` CSS property controls whether the user can select text. This doesn't have any effect on content loaded as chrome, except in textboxes.
   *
   * **Initial value**: `auto`
   ...
   * | 1 _-x-_ | 1 _-x-_ |             |              |              |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"vertical-align"?: VerticalAlignProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"white-space"?: WhiteSpaceProperty;
  /**
   ...
   * | **25** |   No    | **1.3** | **12** | **8** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"will-change"?: WillChangeProperty;
  /**
   * The **`word-break`** CSS property sets whether line breaks appear wherever the text would otherwise overflow its content box.
   *
   * **Initial value**: `normal`
   ...
   * | **1**  | **15**  | **3**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"word-spacing"?: WordSpacingProperty<TLength>;
  /**
   ...
   * | **1**  | **3.5** | **2**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"writing-mode"?: WritingModeProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block"?: BorderBlockProperty<TLength>;
  /**
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block-start"?: BorderBlockStartProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-color"?: BorderColorProperty;
  /**
   * The **`border-image`** CSS property draws an image in place of an element's `border-style`.
   *
   * | Chrome  |  Firefox  | Safari  |  Edge  |   IE   |
   ...
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline"?: BorderInlineProperty<TLength>;
  /**
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline-start"?: BorderInlineStartProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-radius"?: BorderRadiusProperty<TLength>;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-style"?: BorderStyleProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-width"?: BorderWidthProperty<TLength>;
  /**
   * The **`column-rule`** CSS property sets the width, style, and color of the rule (line) drawn between columns in a multi-column layout.
   *
   * | Chrome  |  Firefox  | Safari  |  Edge  |   IE   |
   ...
   * | 1 _-x-_ | 3.5 _-x-_ | 3 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"flex-flow"?: FlexFlowProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **3** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-area"?: GridAreaProperty;
  /**
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-row"?: GridRowProperty;
  /**
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"list-style"?: ListStyleProperty;
  /**
   ...
   * | **1**  |  **1**  | **1**  | **12** | **3** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"mask-border"?: MaskBorderProperty;
  /**
   ...
   * | 46 _(motion)_ |         |        |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"place-items"?: PlaceItemsProperty;
  /**
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-decoration"?: TextDecorationProperty<TLength>;
  /**
   * The **`text-emphasis`** CSS property applies emphasis marks to text (except spaces and control characters). It is a shorthand for `text-emphasis-style` and `text-emphasis-color`.
   *
   * | Chrome | Firefox | Safari  | Edge | IE  |
   ...
   * | **25** | **46**  | **6.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"-moz-animation-delay"?: GlobalsString;
  /**
   * The **`animation-direction`** CSS property sets whether an animation should play forwards, backwards, or alternating back and forth.
   *
   * **Initial value**: `normal`
...
export interface DELETED_BASE64_STRING<TLength = string | 0> {
  /**
   * The CSS **`align-content`** property sets how the browser distributes space between and around content items along the cross-axis of a flexbox container, and the main-axis of a grid container.
   *
   * **Initial value**: `normal`
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"align-items"?: AlignItemsProperty | AlignItemsProperty[];
  /**
   * The **`align-self`** CSS property aligns flex items of the current flex line overriding the `align-items` value. If any of the item's cross-axis margin is set to `auto`, then `align-self` is ignored. In Grid layout `align-self` aligns the item inside the grid area.
   *
   * **Initial value**: `auto`
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"animation-delay"?: GlobalsString | GlobalsString[];
  /**
   * The **`animation-direction`** CSS property sets whether an animation should play forwards, backwards, or alternating back and forth.
   *
   * **Initial value**: `normal`
   ...
   * | 3 _-x-_ | 5 _-x-_ | 4 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"animation-duration"?: GlobalsString | GlobalsString[];
  /**
   * The **`animation-fill-mode`** CSS property sets how a CSS animation applies styles to its target before and after its execution.
   *
   * **Initial value**: `none`
   ...
   * | 3 _-x-_ | 5 _-x-_ | 5 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"animation-iteration-count"?: AnimationIterationCountProperty | AnimationIterationCountProperty[];
  /**
   * The **`animation-name`** CSS property sets one or more animations to apply to an element. Each name is an `@keyframes` at-rule that sets the property values for the animation sequence.
   *
   * **Initial value**: `none`
   ...
   * | 3 _-x-_ | 5 _-x-_ | 4 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"animation-play-state"?: AnimationPlayStateProperty | AnimationPlayStateProperty[];
  /**
   * The `**animation-timing-function**` CSS property sets how an animation progresses through the duration of each cycle.
   *
   * **Initial value**: `ease`
   ...
   * | 3 _-x-_ | 5 _-x-_ | 4 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"backdrop-filter"?: BackdropFilterProperty | BackdropFilterProperty[];
  /**
   * The **`backface-visibility`** CSS property sets whether the back face of an element is visible when turned towards the user.
   *
   * **Initial value**: `visible`
   ...
   * | 12 _-x-_ | 10 _-x-_ |               |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"background-attachment"?: BackgroundAttachmentProperty | BackgroundAttachmentProperty[];
  /**
   * The **`background-blend-mode`** CSS property sets how an element's background images should blend with each other and with the element's background color.
   *
   * **Initial value**: `normal`
   ...
   * | **35** | **30**  | **8**  |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"background-clip"?: BackgroundClipProperty | BackgroundClipProperty[];
  /**
   * The **`background-color`** CSS property sets the background color of an element.
   *
   * **Initial value**: `transparent`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"background-image"?: BackgroundImageProperty | BackgroundImageProperty[];
  /**
   * The **`background-origin`** CSS property sets the _background positioning area_. In other words, it sets the origin position of an image set with the `background-image` property.
   *
   * **Initial value**: `padding-box`
   ...
   * | **1**  |  **4**  | **3**  | **12** | **9** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"background-position"?: BackgroundPositionProperty<TLength> | BackgroundPositionProperty<TLength>[];
  /**
   * The **`background-position-x`** CSS property sets the initial horizontal position for each background image. The position is relative to the position layer set by `background-origin`.
   *
   * **Initial value**: `left`
   ...
   * | **1**  | **49**  | **1**  | **12** | **6** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"background-position-y"?: BackgroundPositionYProperty<TLength> | BackgroundPositionYProperty<TLength>[];
  /**
   * The **`background-repeat`** CSS property sets how background images are repeated. A background image can be repeated along the horizontal and vertical axes, or not repeated at all.
   *
   * **Initial value**: `repeat`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"background-size"?: BackgroundSizeProperty<TLength> | BackgroundSizeProperty<TLength>[];
  /** **Initial value**: `clip` */
   ...
   * | **57** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block-color"?: BorderBlockColorProperty | BorderBlockColorProperty[];
  /**
   * The **`border-block-end-color`** CSS property defines the color of the logical block-end border of an element, which maps to a physical border color depending on the element's writing mode, directionality, and text orientation. It corresponds to the `border-top-color`, `border-right-color`, `border-bottom-color`, or `border-left-color` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `currentcolor`
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block-end-style"?: BorderBlockEndStyleProperty | BorderBlockEndStyleProperty[];
  /**
   * The **`border-block-end-width`** CSS property defines the width of the logical block-end border of an element, which maps to a physical border width depending on the element's writing mode, directionality, and text orientation. It corresponds to the `border-top-width`, `border-right-width`, `border-bottom-width`, or `border-left-width` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `medium`
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block-start-color"?: BorderBlockStartColorProperty | BorderBlockStartColorProperty[];
  /**
   * The **`border-block-start-style`** CSS property defines the style of the logical block start border of an element, which maps to a physical border style depending on the element's writing mode, directionality, and text orientation. It corresponds to the `border-top-style`, `border-right-style`, `border-bottom-style`, or `border-left-style` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `none`
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block-start-width"?: BorderBlockStartWidthProperty<TLength> | BorderBlockStartWidthProperty<TLength>[];
  /**
   * The **`border-block-style`** CSS property defines the style of the logical block borders of an element, which maps to a physical border style depending on the element's writing mode, directionality, and text orientation. It corresponds to the `border-top-style` and `border-bottom-style`, or `border-left-style` and `border-right-style` properties depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `none`
   ...
   * | **69** | **66**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block-width"?: BorderBlockWidthProperty<TLength> | BorderBlockWidthProperty<TLength>[];
  /**
   * The **`border-bottom-color`** CSS property sets the color of an element's bottom border. It can also be set with the shorthand CSS properties `border-color` or `border-bottom`.
   *
   * **Initial value**: `currentcolor`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-bottom-left-radius"?: BorderBottomLeftRadiusProperty<TLength> | BorderBottomLeftRadiusProperty<TLength>[];
  /**
   * The **`border-bottom-right-radius`** CSS property rounds the bottom-right corner of an element.
   *
   * **Initial value**: `0`
   ...
   * | 1 _-x-_ |         | 3 _-x-_ |        |       |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-bottom-style"?: BorderBottomStyleProperty | BorderBottomStyleProperty[];
  /**
   * The **`border-bottom-width`** CSS property sets the width of the bottom border of a box.
   *
   * **Initial value**: `medium`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-collapse"?: BorderCollapseProperty | BorderCollapseProperty[];
  /**
   * The **`border-end-end-radius`** CSS property defines a logical border radius on an element, which maps to a physical border radius that depends on on the element's `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `0`
   ...
   * |   No   | **66**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-end-start-radius"?: BorderEndStartRadiusProperty<TLength> | BorderEndStartRadiusProperty<TLength>[];
  /**
   * The **`border-image-outset`** CSS property sets the distance by which an element's border image is set out from its border box.
   *
   * **Initial value**: `0`
   ...
   * | **15** | **15**  | **6**  | **12** | **11** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-image-repeat"?: BorderImageRepeatProperty | BorderImageRepeatProperty[];
  /**
   * The **`border-image-slice`** CSS property divides the image specified by `border-image-source` into regions. These regions form the components of an element's border image.
   *
   * **Initial value**: `100%`
   ...
   * | **15** | **15**  | **6**  | **12** | **11** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-image-source"?: BorderImageSourceProperty | BorderImageSourceProperty[];
  /**
   * The **`border-image-width`** CSS property sets the width of an element's border image.
   *
   * **Initial value**: `1`
   ...
   * | **15** | **13**  | **6**  | **12** | **11** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline-color"?: BorderInlineColorProperty | BorderInlineColorProperty[];
  /**
   * The **`border-inline-end-color`** CSS property defines the color of the logical inline-end border of an element, which maps to a physical border color depending on the element's writing mode, directionality, and text orientation. It corresponds to the `border-top-color`, `border-right-color`, `border-bottom-color`, or `border-left-color` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `currentcolor`
   ...
   * |        | 3 _(-moz-border-end-color)_ |          |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline-end-style"?: BorderInlineEndStyleProperty | BorderInlineEndStyleProperty[];
  /**
   * The **`border-inline-end-width`** CSS property defines the width of the logical inline-end border of an element, which maps to a physical border width depending on the element's writing mode, directionality, and text orientation. It corresponds to the `border-top-width`, `border-right-width`, `border-bottom-width`, or `border-left-width` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `medium`
   ...
   * |        | 3 _(-moz-border-end-width)_ |          |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline-start-color"?: BorderInlineStartColorProperty | BorderInlineStartColorProperty[];
  /**
   * The **`border-inline-start-style`** CSS property defines the style of the logical inline start border of an element, which maps to a physical border style depending on the element's writing mode, directionality, and text orientation. It corresponds to the `border-top-style`, `border-right-style`, `border-bottom-style`, or `border-left-style` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `none`
   ...
   * |        | 3 _(-moz-border-start-style)_ |          |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline-start-width"?: BorderInlineStartWidthProperty<TLength> | BorderInlineStartWidthProperty<TLength>[];
  /**
   * The **`border-inline-style`** CSS property defines the style of the logical inline borders of an element, which maps to a physical border style depending on the element's writing mode, directionality, and text orientation. It corresponds to the `border-top-style` and `border-bottom-style`, or `border-left-style` and `border-right-style` properties depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `none`
   ...
   * | **69** | **66**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline-width"?: BorderInlineWidthProperty<TLength> | BorderInlineWidthProperty<TLength>[];
  /**
   * The **`border-left-color`** CSS property sets the color of an element's left border. It can also be set with the shorthand CSS properties `border-color` or `border-left`.
   *
   * **Initial value**: `currentcolor`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-left-style"?: BorderLeftStyleProperty | BorderLeftStyleProperty[];
  /**
   * The **`border-left-width`** CSS property sets the width of the left border of an element.
   *
   * **Initial value**: `medium`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-right-color"?: BorderRightColorProperty | BorderRightColorProperty[];
  /**
   * The **`border-right-style`** CSS property sets the line style of an element's right `border`.
   *
   * **Initial value**: `none`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-right-width"?: BorderRightWidthProperty<TLength> | BorderRightWidthProperty<TLength>[];
  /**
   * The **`border-spacing`** CSS property sets the distance between the borders of adjacent `<table>` cells. This property applies only when `border-collapse` is `separate`.
   *
   * **Initial value**: `0`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **8** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-start-end-radius"?: BorderStartEndRadiusProperty<TLength> | BorderStartEndRadiusProperty<TLength>[];
  /**
   * The **`border-start-start-radius`** CSS property defines a logical border radius on an element, which maps to a physical border radius that depends on the element's `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `0`
   ...
   * |   No   | **66**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-top-color"?: BorderTopColorProperty | BorderTopColorProperty[];
  /**
   * The **`border-top-left-radius`** CSS property rounds the top-left corner of an element.
   *
   * **Initial value**: `0`
   ...
   * | 1 _-x-_ |         | 3 _-x-_ |        |       |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-top-right-radius"?: BorderTopRightRadiusProperty<TLength> | BorderTopRightRadiusProperty<TLength>[];
  /**
   * The **`border-top-style`** CSS property sets the line style of an element's top `border`.
   *
   * **Initial value**: `none`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-top-width"?: BorderTopWidthProperty<TLength> | BorderTopWidthProperty<TLength>[];
  /**
   * The **`bottom`** CSS property participates in specifying the vertical position of a _positioned element_. It has no effect on non-positioned elements.
   *
   * **Initial value**: `auto`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"box-decoration-break"?: BoxDecorationBreakProperty | BoxDecorationBreakProperty[];
  /**
   * The **`box-shadow`** CSS property adds shadow effects around an element's frame. You can set multiple effects separated by commas. A box shadow is described by X and Y offsets relative to the element, blur and spread radii, and color.
   *
   * **Initial value**: `none`
   ...
   * | 1 _-x-_ |         | 3 _-x-_ |        |       |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"box-sizing"?: BoxSizingProperty | BoxSizingProperty[];
  /**
   * The **`break-after`** CSS property defines how page, column, or region breaks should behave after a generated box. If there is no generated box, the property is ignored.
   *
   * **Initial value**: `auto`
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"break-before"?: BreakBeforeProperty | BreakBeforeProperty[];
  /**
   * The **`break-inside`** CSS property defines how page, column, or region breaks should behave inside a generated box. If there is no generated box, the property is ignored.
   *
   * **Initial value**: `auto`
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"caption-side"?: CaptionSideProperty | CaptionSideProperty[];
  /**
   * The **`caret-color`** CSS property sets the color of the insertion caret, the visible marker where the next character typed will be inserted. The caret appears in elements such as `<input>` or those with the `contenteditable` attribute. The caret is typically a thin vertical line that flashes to help make it more noticeable. By default, it is black, but its color can be altered with this property.
   *
   * **Initial value**: `auto`
   ...
   * | **57** | **53**  | **11.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"clip-path"?: ClipPathProperty | ClipPathProperty[];
  /**
   * The **`color`** CSS property sets the foreground color value of an element's text and text decorations, and sets the `currentcolor` value. `currentcolor` may be used as an indirect value on _other_ properties and is the default for other color properties, such as `border-color`.
   *
   * **Initial value**: Varies from one browser to another
   ...
   * | **1**  |  **1**  | **1**  | **12** | **3** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"color-adjust"?: ColorAdjustProperty | ColorAdjustProperty[];
  /**
   * The **`column-count`** CSS property breaks an element's content into the specified number of columns.
   *
   * **Initial value**: `auto`
   ...
   * | 1 _-x-_ | 1.5 _-x-_ | 3 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"column-fill"?: ColumnFillProperty | ColumnFillProperty[];
  /**
   * The **`column-gap`** CSS property sets the size of the gap (gutter) between an element's columns.
   *
   * **Initial value**: `normal`
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"column-rule-color"?: ColumnRuleColorProperty | ColumnRuleColorProperty[];
  /**
   * The **`column-rule-style`** CSS property sets the style of the line drawn between columns in a multi-column layout.
   *
   * **Initial value**: `none`
   ...
   * | 1 _-x-_ | 3.5 _-x-_ | 3 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"column-rule-width"?: ColumnRuleWidthProperty<TLength> | ColumnRuleWidthProperty<TLength>[];
  /**
   * The **`column-span`** CSS property makes it possible for an element to span across all columns when its value is set to `all`.
   *
   * **Initial value**: `none`
   ...
   * | 6 _-x-_ |         | 5.1 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"column-width"?: ColumnWidthProperty<TLength> | ColumnWidthProperty<TLength>[];
  /**
   * The **`contain`** CSS property allows an author to indicate that an element and its contents are, as much as possible, _independent_ of the rest of the document tree. This allows the browser to recalculate layout, style, paint, size, or any combination of them for a limited area of the DOM and not the entire page.
   *
   * **Initial value**: `none`
   ...
   * | **52** | **69**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"counter-increment"?: CounterIncrementProperty | CounterIncrementProperty[];
  /**
   * The **`counter-reset`** CSS property resets a CSS counter to a given value.
   *
   * **Initial value**: `none`
   ...
   * | **2**  |  **1**  | **3**  | **12** | **8** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"counter-set"?: CounterSetProperty | CounterSetProperty[];
  /**
   * The **`cursor`** CSS property sets mouse cursor to display when the mouse pointer is over an element.
   *
   * **Initial value**: `auto`
   ...
   * | **1**  |  **1**  | **1.2** | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"empty-cells"?: EmptyCellsProperty | EmptyCellsProperty[];
  /**
   * The **`filter`** CSS property applies graphical effects like blur or color shift to an element. Filters are commonly used to adjust the rendering of images, backgrounds, and borders.
   *
   * **Initial value**: `none`
   ...
   * | 18 _-x-_ |         | 6 _-x-_ |        |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"flex-basis"?: FlexBasisProperty<TLength> | FlexBasisProperty<TLength>[];
  /**
   * The **`flex-direction`** CSS property sets how flex items are placed in the flex container defining the main axis and the direction (normal or reversed).
   *
   * **Initial value**: `row`
   ...
   * | 21 _-x-_ |         | 7 _-x-_ |        | 10 _-x-_ |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"flex-grow"?: GlobalsNumber | GlobalsNumber[];
  /**
   * The **`flex-shrink`** CSS property sets the flex shrink factor of a flex item. If the size of flex items is larger than the flex container, items shrink to fit according to `flex-shrink`.
   *
   * **Initial value**: `1`
   ...
   * | 21 _-x-_ |         | 8 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"flex-wrap"?: FlexWrapProperty | FlexWrapProperty[];
  /**
   * The **`float`** CSS property places an element on the left or right side of its container, allowing text and inline elements to wrap around it. The element is removed from the normal flow of the page, though still remaining a part of the flow (in contrast to absolute positioning).
   *
   * **Initial value**: `none`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-family"?: FontFamilyProperty | FontFamilyProperty[];
  /**
   * The **`font-feature-settings`** CSS property controls advanced typographic features in OpenType fonts.
   *
   * **Initial value**: `normal`
   ...
   * | 16 _-x-_ | 15 _-x-_ |         |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-kerning"?: FontKerningProperty | FontKerningProperty[];
  /**
   * The **`font-language-override`** CSS property controls the use of language-specific glyphs in a typeface.
   *
   * **Initial value**: `normal`
   ...
   * |        | 4 _-x-_ |        |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-optical-sizing"?: FontOpticalSizingProperty | FontOpticalSizingProperty[];
  /**
   * The **`font-size`** CSS property sets the size of the font. This property is also used to compute the size of `em`, `ex`, and other relative `<length>` units.
   *
   * **Initial value**: `medium`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-size-adjust"?: FontSizeAdjustProperty | FontSizeAdjustProperty[];
  /**
   * The **`font-stretch`** CSS property selects a normal, condensed, or expanded face from a font.
   *
   * **Initial value**: `normal`
   ...
   * | **60** |  **9**  | **11** | **12** | **9** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-style"?: FontStyleProperty | FontStyleProperty[];
  /**
   * The **`font-synthesis`** CSS property controls which missing typefaces, bold or italic, may be synthesized by the browser.
   *
   * **Initial value**: `weight style`
   ...
   * |   No   | **34**  | **9**  |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-variant"?: FontVariantProperty | FontVariantProperty[];
  /**
   * The **`font-variant-caps`** CSS property controls the use of alternate glyphs for capital letters.
   *
   * **Initial value**: `normal`
   ...
   * | **52** | **34**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-variant-east-asian"?: FontVariantEastAsianProperty | FontVariantEastAsianProperty[];
  /**
   * The **`font-variant-ligatures`** CSS property controls which ligatures and contextual forms are used in textual content of the elements it applies to. This leads to more harmonized forms in the resulting text.
   *
   * **Initial value**: `normal`
   ...
   * | 31 _-x-_ |         | 7 _-x-_ |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-variant-numeric"?: FontVariantNumericProperty | FontVariantNumericProperty[];
  /**
   * The **`font-variant-position`** CSS property controls the use of alternate, smaller glyphs that are positioned as superscript or subscript.
   *
   * **Initial value**: `normal`
   ...
   * |   No   | **34**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"font-variation-settings"?: FontVariationSettingsProperty | FontVariationSettingsProperty[];
  /**
   * The **`font-weight`** CSS property specifies the weight (or boldness) of the font. The font weights available to you will depend on the `font-family` you are using. Some fonts are only available in `normal` and `bold`.
   *
   * **Initial value**: `normal`
   ...
   * | **2**  |  **1**  | **1**  | **12** | **3** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-auto-columns"?: GridAutoColumnsProperty<TLength> | GridAutoColumnsProperty<TLength>[];
  /**
   * The **`grid-auto-flow`** CSS property controls how the auto-placement algorithm works, specifying exactly how auto-placed items get flowed into the grid.
   *
   * **Initial value**: `row`
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-auto-rows"?: GridAutoRowsProperty<TLength> | GridAutoRowsProperty<TLength>[];
  /**
   * The **`grid-column-end`** CSS property specifies a grid item’s end position within the grid column by contributing a line, a span, or nothing (automatic) to its grid placement, thereby specifying the block-end edge of its grid area.
   *
   * **Initial value**: `auto`
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-column-start"?: GridColumnStartProperty | GridColumnStartProperty[];
  /**
   * The **`grid-row-end`** CSS property specifies a grid item’s end position within the grid row by contributing a line, a span, or nothing (automatic) to its grid placement, thereby specifying the inline-end edge of its grid area.
   *
   * **Initial value**: `auto`
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-row-start"?: GridRowStartProperty | GridRowStartProperty[];
  /**
   * The **`grid-template-areas`** CSS property specifies named grid areas.
   *
   * **Initial value**: `none`
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-template-columns"?: GridTemplateColumnsProperty<TLength> | GridTemplateColumnsProperty<TLength>[];
  /**
   * The **`grid-template-rows`** CSS property defines the line names and track sizing functions of the grid rows.
   *
   * **Initial value**: `none`
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"hanging-punctuation"?: HangingPunctuationProperty | HangingPunctuationProperty[];
  /**
   * The **`height`** CSS property specifies the height of an element. By default, the property defines the height of the content area. If `box-sizing` is set to `border-box`, however, it instead determines the height of the border area.
   *
   * **Initial value**: `auto`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"image-orientation"?: ImageOrientationProperty | ImageOrientationProperty[];
  /**
   * The **`image-rendering`** CSS property sets an image scaling algorithm. The property applies to an element itself, to any images set in its other properties, and to its descendants.
   *
   * **Initial value**: `auto`
   ...
   * | **13** | **3.6** | **6**  |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"initial-letter"?: InitialLetterProperty | InitialLetterProperty[];
  /**
   * The **`inline-size`** CSS property defines the horizontal or vertical size of an element's block, depending on its writing mode. It corresponds to either the `width` or the `height` property, depending on the value of `writing-mode`.
   *
   * **Initial value**: `auto`
   ...
   * | **57** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"inset-block"?: InsetBlockProperty<TLength> | InsetBlockProperty<TLength>[];
  /**
   * The **`inset-block-end`** CSS property defines the logical block end offset of an element, which maps to a physical inset depending on the element's writing mode, directionality, and text orientation. It corresponds to the `top`, `right`, `bottom`, or `left` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `auto`
   ...
   * |  n/a   | **63**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"inset-block-start"?: InsetBlockStartProperty<TLength> | InsetBlockStartProperty<TLength>[];
  /**
   * The **`inset-inline`** CSS property defines the logical block start and end offsets of an element, which maps to physical offsets depending on the element's writing mode, directionality, and text orientation. It corresponds to the `top` and `bottom`, or `right` and `left` properties depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `auto`
   ...
   * |  n/a   | **63**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"inset-inline-end"?: InsetInlineEndProperty<TLength> | InsetInlineEndProperty<TLength>[];
  /**
   * The **`inset-inline-start`** CSS property defines the logical inline start inset of an element, which maps to a physical offset depending on the element's writing mode, directionality, and text orientation. It corresponds to the `top`, `right`, `bottom`, or `left` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `auto`
   ...
   * |  n/a   | **63**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"justify-content"?: JustifyContentProperty | JustifyContentProperty[];
  /**
   * The CSS **`justify-items`** property defines the default `justify-self` for all items of the box, giving them all a default way of justifying each box along the appropriate axis.
   *
   * **Initial value**: `legacy`
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"justify-self"?: JustifySelfProperty | JustifySelfProperty[];
  /**
   * The **`left`** CSS property participates in specifying the horizontal position of a _positioned element_. It has no effect on non-positioned elements.
   *
   * **Initial value**: `auto`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"letter-spacing"?: LetterSpacingProperty<TLength> | LetterSpacingProperty<TLength>[];
  /**
   * The **`line-break`** CSS property sets how to break lines of Chinese, Japanese, or Korean (CJK) text when working with punctuation and symbols.
   *
   * **Initial value**: `auto`
   ...
   * | 1 _-x-_ |         |             |        |         |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"line-height"?: LineHeightProperty<TLength> | LineHeightProperty<TLength>[];
  /**
   * The **`line-height-step`** CSS property sets the step unit for line box heights. When the property is set, line box heights are rounded up to the closest multiple of the unit.
   *
   * **Initial value**: `0`
   ...
   * |  n/a   |   No    |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"list-style-image"?: ListStyleImageProperty | ListStyleImageProperty[];
  /**
   * The **`list-style-position`** CSS property sets the position of the `::marker` relative to a list item.
   *
   * **Initial value**: `outside`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"list-style-type"?: ListStyleTypeProperty | ListStyleTypeProperty[];
  /**
   * The **`margin-block`** CSS property defines the logical block start and end margins of an element, which maps to physical margins depending on the element's writing mode, directionality, and text orientation.
   *
   * **Initial value**: `0`
   ...
   * | **69** | **66**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"margin-block-end"?: MarginBlockEndProperty<TLength> | MarginBlockEndProperty<TLength>[];
  /**
   * The **`margin-block-start`** CSS property defines the logical block start margin of an element, which maps to a physical margin depending on the element's writing mode, directionality, and text orientation.
   *
   * **Initial value**: `0`
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"margin-bottom"?: MarginBottomProperty<TLength> | MarginBottomProperty<TLength>[];
  /**
   * The **`margin-inline`** CSS property defines the logical inline start and end margins of an element, which maps to physical margins depending on the element's writing mode, directionality, and text orientation.
   *
   * **Initial value**: `0`
   ...
   * | **69** | **66**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"margin-inline-end"?: MarginInlineEndProperty<TLength> | MarginInlineEndProperty<TLength>[];
  /**
   * The **`margin-inline-start`** CSS property defines the logical inline start margin of an element, which maps to a physical margin depending on the element's writing mode, directionality, and text orientation. It corresponds to the `margin-top`, `margin-right`, `margin-bottom`, or `margin-left` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `0`
   ...
   * | 2 _(-webkit-margin-start)_ | 3 _(-moz-margin-start)_ | 3 _(-webkit-margin-start)_ |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"margin-left"?: MarginLeftProperty<TLength> | MarginLeftProperty<TLength>[];
  /**
   * The **`margin-right`** CSS property sets the margin area on the right side of an element. A positive value places it farther from its neighbors, while a negative value places it closer.
   *
   * **Initial value**: `0`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **3** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"margin-top"?: MarginTopProperty<TLength> | MarginTopProperty<TLength>[];
  /**
   * The **`mask-border-mode`** CSS property specifies the blending mode used in a mask border.
   *
   * **Initial value**: `alpha`
   ...
   * | **1** _-x-_ | **53**  | **4** _-x-_ |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"mask-composite"?: MaskCompositeProperty | MaskCompositeProperty[];
  /**
   * The **`mask-image`** CSS property sets the image that is used as mask layer for an element.
   *
   * **Initial value**: `none`
   ...
   * | **1** _-x-_ | **53**  | **4** _-x-_ | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"mask-mode"?: MaskModeProperty | MaskModeProperty[];
  /**
   * The **`mask-origin`** CSS property sets the origin of a mask.
   *
   * **Initial value**: `border-box`
   ...
   * | **1** _-x-_ | **53**  | **4** _-x-_ |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"mask-position"?: MaskPositionProperty<TLength> | MaskPositionProperty<TLength>[];
  /**
   * The **`mask-repeat`** CSS property sets how mask images are repeated. A mask image can be repeated along the horizontal axis, the vertical axis, both axes, or not repeated at all.
   *
   * **Initial value**: `no-repeat`
   ...
   * | **1** _-x-_ | **53**  | **3.2** _-x-_ | **18** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"mask-size"?: MaskSizeProperty<TLength> | MaskSizeProperty<TLength>[];
  /**
   * The **`mask-type`** CSS property sets whether an SVG `<mask>` element is used as a _luminance_ or an _alpha_ mask. It applies to the `<mask>` element itself.
   *
   * **Initial value**: `luminance`
   ...
   * | **24** | **35**  | **6.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"max-block-size"?: MaxBlockSizeProperty<TLength> | MaxBlockSizeProperty<TLength>[];
  /**
   * The **`max-height`** CSS property sets the maximum height of an element. It prevents the used value of the `height` property from becoming larger than the value specified for `max-height`.
   *
   * **Initial value**: `none`
   ...
   * | **18** |  **1**  | **1.3** | **12** | **7** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"max-inline-size"?: MaxInlineSizeProperty<TLength> | MaxInlineSizeProperty<TLength>[];
  /** **Initial value**: `none` */
   ...
   * | **1**  |  **1**  | **1**  | **12** | **7** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"min-block-size"?: MinBlockSizeProperty<TLength> | MinBlockSizeProperty<TLength>[];
  /**
   * The **`min-height`** CSS property sets the minimum height of an element. It prevents the used value of the `height` property from becoming smaller than the value specified for `min-height`.
   *
   * **Initial value**: `auto`
   ...
   * | **1**  |  **3**  | **1.3** | **12** | **7** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"min-inline-size"?: MinInlineSizeProperty<TLength> | MinInlineSizeProperty<TLength>[];
  /**
   * The **`min-width`** CSS property sets the minimum width of an element. It prevents the used value of the `width` property from becoming smaller than the value specified for `min-width`.
   *
   * **Initial value**: `auto`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **7** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"mix-blend-mode"?: MixBlendModeProperty | MixBlendModeProperty[];
  /**
   * The **`offset-distance`** CSS property specifies a position along an `offset-path`.
   *
   * **Initial value**: `0`
   ...
   * | 46 _(motion-distance)_ |         |        |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"motion-path"?: OffsetPathProperty | OffsetPathProperty[];
  /**
   * The **`offset-rotate`** CSS property defines the direction of the element while positioning along the offset path.
   *
   * **Initial value**: `auto`
   ...
   * | 46 _(motion-rotation)_ |         |        |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"object-fit"?: ObjectFitProperty | ObjectFitProperty[];
  /**
   * The **`object-position`** CSS property specifies the alignment of the selected replaced element's contents within the element's box. Areas of the box which aren't covered by the replaced element's object will show the element's background.
   *
   * **Initial value**: `50% 50%`
   ...
   * | **31** | **36**  | **10** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"offset-anchor"?: OffsetAnchorProperty<TLength> | OffsetAnchorProperty<TLength>[];
  /**
   * The **`offset-distance`** CSS property specifies a position along an `offset-path`.
   *
   * **Initial value**: `0`
   ...
   * | 46 _(motion-distance)_ |         |        |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"offset-path"?: OffsetPathProperty | OffsetPathProperty[];
  /** **Initial value**: `auto` */
   ...
   * | 46 _(motion-rotation)_ |         |        |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"offset-rotation"?: OffsetRotateProperty | OffsetRotateProperty[];
  /**
   * The **`opacity`** CSS property sets the transparency of an element or the degree to which content behind an element is visible.
   *
   * **Initial value**: `1.0`
   ...
   * | **1**  |  **1**  | **2**  | **12** | **9** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"outline-color"?: OutlineColorProperty | OutlineColorProperty[];
  /**
   * The **`outline-offset`** CSS property sets the amount of space between an outline and the edge or border of an element.
   *
   * **Initial value**: `0`
   ...
   * | **1**  | **1.5** | **1.2** | **15** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"outline-style"?: OutlineStyleProperty | OutlineStyleProperty[];
  /**
   * The **`outline-width`** CSS property sets the thickness of an element's outline. An outline is a line that is drawn around an element, outside the `border`.
   *
   * **Initial value**: `medium`
   ...
   * | **1**  | **1.5** | **1.2** | **12** | **8** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"overflow-anchor"?: OverflowAnchorProperty | OverflowAnchorProperty[];
  /**
   * **Initial value**: `auto`
   *
   * | Chrome | Firefox | Safari | Edge | IE  |
   ...
   * |   No   | **69**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"overflow-clip-box"?: OverflowClipBoxProperty | OverflowClipBoxProperty[];
  /**
   * **Initial value**: `auto`
   *
   * | Chrome | Firefox | Safari | Edge | IE  |
   ...
   * |   No   | **69**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"overflow-wrap"?: OverflowWrapProperty | OverflowWrapProperty[];
  /**
   * The **`overflow-x`** CSS property sets what shows when content overflows a block-level element's left and right edges. This may be nothing, a scroll bar, or the overflow content.
   *
   * **Initial value**: `visible`
   ...
   * | **1**  | **3.5** | **3**  | **12** | **5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"overflow-y"?: OverflowYProperty | OverflowYProperty[];
  /**
   * The **`overscroll-behavior`** CSS property sets what a browser does when reaching the boundary of a scrolling area. It's a shorthand for `overscroll-behavior-x` and `overscroll-behavior-y`.
   *
   * **Initial value**: `auto`
   ...
   * | **63** | **59**  |   No   | **18** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"overscroll-behavior-x"?: OverscrollBehaviorXProperty | OverscrollBehaviorXProperty[];
  /**
   * The **`overscroll-behavior-y`** CSS property sets the browser's behavior when the vertical boundary of a scrolling area is reached.
   *
   * **Initial value**: `auto`
   ...
   * | **63** | **59**  |   No   | **18** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"padding-block"?: PaddingBlockProperty<TLength> | PaddingBlockProperty<TLength>[];
  /**
   * The **`padding-block-end`** CSS property defines the logical block end padding of an element, which maps to a physical padding depending on the element's writing mode, directionality, and text orientation. It corresponds to the `padding-top`, `padding-right`, `padding-bottom`, or `padding-left` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `0`
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"padding-block-start"?: PaddingBlockStartProperty<TLength> | PaddingBlockStartProperty<TLength>[];
  /**
   * The **`padding-bottom`** CSS property sets the height of the padding area on the bottom of an element.
   *
   * **Initial value**: `0`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"padding-inline"?: PaddingInlineProperty<TLength> | PaddingInlineProperty<TLength>[];
  /**
   * The **`padding-inline-end`** CSS property defines the logical inline end padding of an element, which maps to a physical padding depending on the element's writing mode, directionality, and text orientation. It corresponds to the `padding-top`, `padding-right`, `padding-bottom`, or `padding-left` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
   *
   * **Initial value**: `0`
   ...
   * | 2 _(-webkit-padding-end)_ | 3 _(-moz-padding-end)_ | 3 _(-webkit-padding-end)_ |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"padding-inline-start"?: PaddingInlineStartProperty<TLength> | PaddingInlineStartProperty<TLength>[];
  /**
   * The **`padding-left`** CSS property sets the width of the padding area on the left side of an element.
   *
   * **Initial value**: `0`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"padding-right"?: PaddingRightProperty<TLength> | PaddingRightProperty<TLength>[];
  /**
   * The **`padding-top`** padding area on the top of an element.
   *
   * **Initial value**: `0`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"page-break-after"?: PageBreakAfterProperty | PageBreakAfterProperty[];
  /**
   * The **`page-break-before`** CSS property adjusts page breaks _before_ the current element.
   *
   * **Initial value**: `auto`
   ...
   * | **1**  |  **1**  | **1.2** | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"page-break-inside"?: PageBreakInsideProperty | PageBreakInsideProperty[];
  /**
   * The **`paint-order`** CSS property lets you control the order in which the fill and stroke (and painting markers) of text content and shapes are drawn.
   *
   * **Initial value**: `normal`
   ...
   * | **35** | **60**  | **8**  | **17** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"perspective-origin"?: PerspectiveOriginProperty<TLength> | PerspectiveOriginProperty<TLength>[];
  /**
   * The `**place-content**` CSS property is a shorthand for `align-content` and `justify-content`. It can be used in any layout method which utilizes both of these alignment values.
   *
   * **Initial value**: `normal`
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"pointer-events"?: PointerEventsProperty | PointerEventsProperty[];
  /**
   * The **`position`** CSS property sets how an element is positioned in a document. The `top`, `right`, `bottom`, and `left` properties determine the final location of positioned elements.
   *
   * **Initial value**: `static`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"row-gap"?: RowGapProperty<TLength> | RowGapProperty<TLength>[];
  /**
   * The `**ruby-align**` CSS property defines the distribution of the different ruby elements over the base.
   *
   * **Initial value**: `space-around`
   ...
   * |   No   | **38**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"ruby-position"?: RubyPositionProperty | RubyPositionProperty[];
  /**
   * The **`scale`** CSS property allows you to specify scale transforms individually and independantly of the `transform` property. This maps better to typical user interface usage, and saves having to remember the exact order of transform functions to specify in the `transform` value.
   *
   * **Initial value**: `none`
   ...
   * |   No   |   n/a   |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-behavior"?: ScrollBehaviorProperty | ScrollBehaviorProperty[];
  /**
   * The **`scroll-margin`** property is a shorthand property which sets all of the `scroll-margin` longhands, assigning values much like the `margin` property does for the `margin-*` longhands.
   *
   * **Initial value**: `0`
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-margin-block"?: ScrollMarginBlockProperty<TLength> | ScrollMarginBlockProperty<TLength>[];
  /**
   * The `scroll-margin-block-end` property defines the margin of the scroll snap area at the end of the block dimension that is used for snapping this box to the snapport. The scroll snap area is determined by taking the transformed border box, finding its rectangular bounding box (axis-aligned in the scroll container’s coordinate space), then adding the specified outsets.
   *
   * **Initial value**: `0`
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-margin-block-start"?: ScrollMarginBlockStartProperty<TLength> | ScrollMarginBlockStartProperty<TLength>[];
  /**
   * The `scroll-margin-bottom` property defines the bottom margin of the scroll snap area that is used for snapping this box to the snapport. The scroll snap area is determined by taking the transformed border box, finding its rectangular bounding box (axis-aligned in the scroll container’s coordinate space), then adding the specified outsets.
   *
   * **Initial value**: `0`
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-margin-inline"?: ScrollMarginInlineProperty<TLength> | ScrollMarginInlineProperty<TLength>[];
  /**
   * The `scroll-margin-inline-end` property defines the margin of the scroll snap area at the end of the inline dimension that is used for snapping this box to the snapport. The scroll snap area is determined by taking the transformed border box, finding its rectangular bounding box (axis-aligned in the scroll container’s coordinate space), then adding the specified outsets.
   *
   * **Initial value**: `0`
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-margin-inline-start"?: ScrollMarginInlineStartProperty<TLength> | ScrollMarginInlineStartProperty<TLength>[];
  /**
   * The `scroll-margin-left` property defines the left margin of the scroll snap area that is used for snapping this box to the snapport. The scroll snap area is determined by taking the transformed border box, finding its rectangular bounding box (axis-aligned in the scroll container’s coordinate space), then adding the specified outsets.
   *
   * **Initial value**: `0`
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-margin-right"?: ScrollMarginRightProperty<TLength> | ScrollMarginRightProperty<TLength>[];
  /**
   * The `scroll-margin-top` property defines the top margin of the scroll snap area that is used for snapping this box to the snapport. The scroll snap area is determined by taking the transformed border box, finding its rectangular bounding box (axis-aligned in the scroll container’s coordinate space), then adding the specified outsets.
   *
   * **Initial value**: `0`
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-padding"?: ScrollPaddingProperty<TLength> | ScrollPaddingProperty<TLength>[];
  /**
 * The `scroll-padding-block` property is a shorthand property which sets the scroll-padding longhands for the block dimension.  
 ...
 * | **69** | **68**  |   No   |  No  | No  |
 * 
 * @see DELETED_URL_WITH_CREDENTIALS"scroll-padding-block-end"?: ScrollPaddingBlockEndProperty<TLength> | ScrollPaddingBlockEndProperty<TLength>[];
  /**
   * The `scroll-padding-block-start` property defines offsets for the start edge in the block dimension of the optimal viewing region of the scrollport: the region used as the target region for placing things in view of the user. This allows the author to exclude regions of the scrollport that are obscured by other content (such as fixed-positioned toolbars or sidebars) or simply to put more breathing room between a targetted element and the edges of the scrollport.
   *
   * **Initial value**: `auto`
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-padding-bottom"?: ScrollPaddingBottomProperty<TLength> | ScrollPaddingBottomProperty<TLength>[];
  /**
 * The `scroll-padding-inline` property is a shorthand property which sets the scroll-padding longhands for the inline dimension.  
 ...
 * | **69** | **68**  |   No   |  No  | No  |
 * 
 * @see DELETED_URL_WITH_CREDENTIALS"scroll-padding-inline-end"?: ScrollPaddingInlineEndProperty<TLength> | ScrollPaddingInlineEndProperty<TLength>[];
  /**
   * The `scroll-padding-inline-start` property defines offsets for the start edge in the inline dimension of the optimal viewing region of the scrollport: the region used as the target region for placing things in view of the user. This allows the author to exclude regions of the scrollport that are obscured by other content (such as fixed-positioned toolbars or sidebars) or simply to put more breathing room between a targetted element and the edges of the scrollport.
   *
   * **Initial value**: `auto`
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-padding-left"?: ScrollPaddingLeftProperty<TLength> | ScrollPaddingLeftProperty<TLength>[];
  /**
   * The `scroll-padding-right` property defines offsets for the right of the optimal viewing region of the scrollport: the region used as the target region for placing things in view of the user. This allows the author to exclude regions of the scrollport that are obscured by other content (such as fixed-positioned toolbars or sidebars) or simply to put more breathing room between a targetted element and the edges of the scrollport.
   *
   * **Initial value**: `auto`
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-padding-top"?: ScrollPaddingTopProperty<TLength> | ScrollPaddingTopProperty<TLength>[];
  /**
   * The `scroll-snap-align` property specifies the box’s snap position as an alignment of its snap area (as the alignment subject) within its snap container’s snapport (as the alignment container). The two values specify the snapping alignment in the block axis and inline axis, respectively. If only one value is specified, the second value defaults to the same value.
   *
   * **Initial value**: `none`
   ...
   * | **69** | **68**  | **11** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scroll-snap-stop"?: ScrollSnapStopProperty | ScrollSnapStopProperty[];
  /**
   * The **`scroll-snap-type`** CSS property sets how strictly snap points are enforced on the scroll container in case there is one.
   *
   * **Initial value**: `none`
   ...
   * |        |         | 9 _-x-_ |              |              |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"scrollbar-color"?: ScrollbarColorProperty | ScrollbarColorProperty[];
  /**
   * The `scrollbar-width` property allows the author to set the maximum thickness of an element’s scrollbars when they are shown.
   *
   * **Initial value**: `auto`
   ...
   * |   No   | **64**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"shape-image-threshold"?: ShapeImageThresholdProperty | ShapeImageThresholdProperty[];
  /**
   * The **`shape-margin`** CSS property sets a margin for a CSS shape created using `shape-outside`.
   *
   * **Initial value**: `0`
   ...
   * | **37** | **62**  | **10.1** _-x-_ |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"shape-outside"?: ShapeOutsideProperty | ShapeOutsideProperty[];
  /**
   * The **`tab-size`** CSS property is used to customize the width of a tab (`U+0009`) character.
   *
   * **Initial value**: `8`
   ...
   * | **21** | **4** _-x-_ | **6.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"table-layout"?: TableLayoutProperty | TableLayoutProperty[];
  /**
   * The **`text-align`** CSS property sets the horizontal alignment of an inline or table-cell box. This means it works like `vertical-align` but in the horizontal direction.
   *
   * **Initial value**: `start`, or a nameless value that acts as `left` if _direction_ is `ltr`, `right` if _direction_ is `rtl` if `start` is not supported by the browser.
   ...
   * | **1**  |  **1**  | **1**  | **12** | **3** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-align-last"?: TextAlignLastProperty | TextAlignLastProperty[];
  /**
   * The **`text-combine-upright`** CSS property sets the combination of characters into the space of a single character. If the combined text is wider than 1em, the user agent must fit the contents within 1em. The resulting composition is treated as a single upright glyph for layout and decoration. This property only has an effect in vertical writing modes.
   *
   * **Initial value**: `none`
   ...
   * | 9 _(-webkit-text-combine)_ |         |                                  |                                        |                                        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-decoration-color"?: TextDecorationColorProperty | TextDecorationColorProperty[];
  /**
   * The **`text-decoration-line`** CSS property sets the kind of decoration that is used on text in an element, such as an underline or overline.
   *
   * **Initial value**: `none`
   ...
   * |        |         | 8 _-x-_  |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-decoration-skip"?: TextDecorationSkipProperty | TextDecorationSkipProperty[];
  /**
   * The **`text-decoration-skip-ink`** CSS property specifies how overlines and underlines are drawn when they pass over glyph ascenders and descenders.
   *
   * **Initial value**: `auto`
   ...
   * | **64** | **70**  |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-decoration-style"?: TextDecorationStyleProperty | TextDecorationStyleProperty[];
  /**
   * The **`text-decoration-thickness`** CSS property sets the thickness, or width, of the decoration line that is used on text in an element, such as a line-through, underline, or overline.
   *
   * **Initial value**: `auto`
   ...
   * |   No   | **70**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-decoration-width"?: TextDecorationThicknessProperty<TLength> | TextDecorationThicknessProperty<TLength>[];
  /**
   * The **`text-emphasis-color`** CSS property sets the color of emphasis marks. This value can also be set using the `text-emphasis` shorthand.
   *
   * **Initial value**: `currentcolor`
   ...
   * | **25** | **46**  | **6.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-emphasis-position"?: GlobalsString | GlobalsString[];
  /**
   * The **`text-emphasis-style`** CSS property sets the appearance of emphasis marks. It can also be set, and reset, using the `text-emphasis` shorthand.
   *
   * **Initial value**: `none`
   ...
   * | **25** | **46**  | **6.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-indent"?: TextIndentProperty<TLength> | TextIndentProperty<TLength>[];
  /**
   * The **`text-justify`** CSS property sets what type of justification should be applied to text when `text-align``: justify;` is set on an element.
   *
   * **Initial value**: `auto`
   ...
   * |  n/a   | **55**  |   No   | **12** | **11** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-orientation"?: TextOrientationProperty | TextOrientationProperty[];
  /**
   * The **`text-overflow`** CSS property sets how hidden overflow content is signaled to users. It can be clipped, display an ellipsis ('`…`'), or display a custom string.
   *
   * **Initial value**: `clip`
   ...
   * | **1**  |  **7**  | **1.3** | **12** | **6** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-rendering"?: TextRenderingProperty | TextRenderingProperty[];
  /**
   * The **`text-shadow`** CSS property adds shadows to text. It accepts a comma-separated list of shadows to be applied to the text and any of its `decorations`. Each shadow is described by some combination of X and Y offsets from the element, blur radius, and color.
   *
   * **Initial value**: `none`
   ...
   * | **2**  | **3.5** | **1.1** | **12** | **10** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-size-adjust"?: TextSizeAdjustProperty | TextSizeAdjustProperty[];
  /**
   * The **`text-transform`** CSS property specifies how to capitalize an element's text. It can be used to make text appear in all-uppercase or all-lowercase, or with each word capitalized. It also can help improve legibility for ruby
   *
   * **Initial value**: `none`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-underline-offset"?: TextUnderlineOffsetProperty<TLength> | TextUnderlineOffsetProperty<TLength>[];
  /**
   * The **`text-underline-position`** CSS property specifies the position of the underline which is set using the `text-decoration` property's `underline` value.
   *
   * **Initial value**: `auto`
   ...
   * | **33** |   No    |   No   | **12** | **6** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"touch-action"?: TouchActionProperty | TouchActionProperty[];
  /**
   * The **`transform`** CSS property lets you rotate, scale, skew, or translate an element. It modifies the coordinate space of the CSS visual formatting model.
   *
   * **Initial value**: `none`
   ...
   * | 1 _-x-_ |         | 3.1 _-x-_ |        | 9 _-x-_ |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"transform-box"?: TransformBoxProperty | TransformBoxProperty[];
  /**
   * The **`transform-origin`** CSS property sets the origin for an element's transformations.
   *
   * **Initial value**: `50% 50% 0`
   ...
   * | 1 _-x-_ | 3.5 _-x-_ | 2 _-x-_ |        | 9 _-x-_ |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"transform-style"?: TransformStyleProperty | TransformStyleProperty[];
  /**
   * The **`transition-delay`** CSS property specifies the duration to wait before starting a property's transition effect when its value changes.
   *
   * **Initial value**: `0s`
   ...
   * | 1 _-x-_ | 4 _-x-_ | 4 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"transition-duration"?: GlobalsString | GlobalsString[];
  /**
   * The **`transition-property`** CSS property sets the CSS properties to which a transition effect should be applied.
   *
   * **Initial value**: all
   ...
   * | 1 _-x-_ | 4 _-x-_ | 3.1 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"transition-timing-function"?: TransitionTimingFunctionProperty | TransitionTimingFunctionProperty[];
  /**
   * The **`translate`** CSS property allows you to specify translation transforms individually and independantly of the `transform` property. This maps better to typical user interface usage, and saves having to remember the exact order of transform functions to specify in the `transform` value.
   *
   * **Initial value**: `none`
   ...
   * |   No   |   n/a   |   No   |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"unicode-bidi"?: UnicodeBidiProperty | UnicodeBidiProperty[];
  /**
   * The `**user-select**` CSS property controls whether the user can select text. This doesn't have any effect on content loaded as chrome, except in textboxes.
   *
   * **Initial value**: `auto`
   ...
   * | 1 _-x-_ | 1 _-x-_ |             |              |              |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"vertical-align"?: VerticalAlignProperty<TLength> | VerticalAlignProperty<TLength>[];
  /**
   * The **`visibility`** CSS property shows or hides an element without changing the layout of a document. The property can also hide rows or columns in a `<table>`.
   *
   * **Initial value**: `visible`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"white-space"?: WhiteSpaceProperty | WhiteSpaceProperty[];
  /**
   * The **`widows`** CSS property sets the minimum number of lines in a block container that must be shown at the _top_ of a page, region, or column.
   *
   * **Initial value**: `2`
   ...
   * | **25** |   No    | **1.3** | **12** | **8** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"will-change"?: WillChangeProperty | WillChangeProperty[];
  /**
   * The **`word-break`** CSS property sets whether line breaks appear wherever the text would otherwise overflow its content box.
   *
   * **Initial value**: `normal`
   ...
   * | **1**  | **15**  | **3**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"word-spacing"?: WordSpacingProperty<TLength> | WordSpacingProperty<TLength>[];
  /**
   * The `**overflow-wrap**` CSS property sets whether the browser should insert line breaks within words to prevent text from overflowing its content box.
   *
   * **Initial value**: `normal`
   ...
   * | **1**  | **3.5** | **2**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"writing-mode"?: WritingModeProperty | WritingModeProperty[];
  /**
   * The **`z-index`** CSS property sets the z-order of a positioned element and its descendants or flex items. Overlapping elements with a larger z-index cover those with a smaller one.
   *
   * **Initial value**: `auto`
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block"?: BorderBlockProperty<TLength> | BorderBlockProperty<TLength>[];
  /**
   * The **`border-block-end`** CSS property is a shorthand property for setting the individual logical block-end border property values in a single place in the style sheet.
   *
   * | Chrome | Firefox |  Safari  | Edge | IE  |
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-block-start"?: BorderBlockStartProperty<TLength> | BorderBlockStartProperty<TLength>[];
  /**
   * The **`border-bottom`** CSS property is a shorthand that sets the values of `border-bottom-width`, `border-bottom-style` and `border-bottom-color`. These properties set an element's bottom border.
   *
   * | Chrome | Firefox | Safari |  Edge  |  IE   |
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-color"?: BorderColorProperty | BorderColorProperty[];
  /**
   * The **`border-image`** CSS property draws an image in place of an element's `border-style`.
   *
   * | Chrome  |  Firefox  | Safari  |  Edge  |   IE   |
   ...
   * | 7 _-x-_ | 3.5 _-x-_ | 3 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline"?: BorderInlineProperty<TLength> | BorderInlineProperty<TLength>[];
  /**
   * The **`border-inline-end`** CSS property is a shorthand property for setting the individual logical inline-end border property values in a single place in the style sheet.
   *
   * | Chrome | Firefox |  Safari  | Edge | IE  |
   ...
   * | **69** | **41**  | **12.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-inline-start"?: BorderInlineStartProperty<TLength> | BorderInlineStartProperty<TLength>[];
  /**
   * The **`border-left`** CSS property is a shorthand that sets the values of `border-left-width`, `border-left-style` and `border-left-color`. These properties set an element's left border.
   *
   * | Chrome | Firefox | Safari |  Edge  |  IE   |
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-radius"?: BorderRadiusProperty<TLength> | BorderRadiusProperty<TLength>[];
  /**
   * The **`border-right`** CSS property is a shorthand that sets the values of `border-right-width`, `border-right-style` and `border-right-color`. These properties set an element's right border.
   *
   * | Chrome | Firefox | Safari |  Edge  |   IE    |
   ...
   * | **1**  |  **1**  | **1**  | **12** | **5.5** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-style"?: BorderStyleProperty | BorderStyleProperty[];
  /**
   * The **`border-top`** CSS property is a shorthand that sets the values of `border-top-width`, `border-top-style` and `border-top-color`. These properties set an element's top border.
   *
   * | Chrome | Firefox | Safari |  Edge  |  IE   |
   ...
   * | **1**  |  **1**  | **1**  | **12** | **4** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"border-width"?: BorderWidthProperty<TLength> | BorderWidthProperty<TLength>[];
  /**
   * The **`column-rule`** CSS property sets the width, style, and color of the rule (line) drawn between columns in a multi-column layout.
   *
   * | Chrome  |  Firefox  | Safari  |  Edge  |   IE   |
   ...
   * | 1 _-x-_ | 3.5 _-x-_ | 3 _-x-_ |        |        |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"flex-flow"?: FlexFlowProperty | FlexFlowProperty[];
  /**
   * The **`font`** CSS property is a shorthand for `font-style`, `font-variant`, `font-weight`, `font-size`, `line-height`, and `font-family`. Alternatively, it sets an element's font to a system font.
   *
   * | Chrome | Firefox | Safari |  Edge  |  IE   |
   ...
   * | **1**  |  **1**  | **1**  | **12** | **3** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-area"?: GridAreaProperty | GridAreaProperty[];
  /**
   * The **`grid-column`** CSS property is a shorthand property for `grid-column-start` and `grid-column-end` specifying a grid item's size and location within the grid column by contributing a line, a span, or nothing (automatic) to its grid placement, thereby specifying the inline-start and inline-end edge of its grid area.
   *
   * | Chrome | Firefox |  Safari  |  Edge  | IE  |
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"grid-row"?: GridRowProperty | GridRowProperty[];
  /**
   * The **`grid-template`** CSS property is a shorthand property for defining grid columns, rows, and areas.
   *
   * | Chrome | Firefox |  Safari  |  Edge  | IE  |
   ...
   * | **57** | **52**  | **10.1** | **16** | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"list-style"?: ListStyleProperty | ListStyleProperty[];
  /**
   * The **`margin`** CSS property sets the margin area on all four sides of an element. It is a shorthand for `margin-top`, `margin-right`, `margin-bottom`, and `margin-left`.
   *
   * | Chrome | Firefox | Safari |  Edge  |  IE   |
   ...
   * | **1**  |  **1**  | **1**  | **12** | **3** |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"mask-border"?: MaskBorderProperty | MaskBorderProperty[];
  /**
   * The **`offset`** CSS property is a shorthand property for animating an element along a defined path.
   *
   * |    Chrome     | Firefox | Safari | Edge | IE  |
   ...
   * | 46 _(motion)_ |         |        |      |     |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"place-items"?: PlaceItemsProperty | PlaceItemsProperty[];
  /**
   * The **`place-self`** CSS property is a shorthand property sets both the `align-self` and `justify-self` properties. The first value is the `align-self` property value, the second the `justify-self` one. If the second value is not present, the first value is also used for it.
   *
   * ---
   ...
   * ---
   *
   * @see DELETED_URL_WITH_CREDENTIALS"text-decoration"?: TextDecorationProperty<TLength> | TextDecorationProperty<TLength>[];
  /**
   * The **`text-emphasis`** CSS property applies emphasis marks to text (except spaces and control characters). It is a shorthand for `text-emphasis-style` and `text-emphasis-color`.
   *
   * | Chrome | Firefox | Safari  | Edge | IE  |
   ...
   * | **25** | **46**  | **6.1** |  No  | No  |
   *
   * @see DELETED_URL_WITH_CREDENTIALS"-moz-animation-delay"?: GlobalsString | GlobalsString[];
  /**
   * The **`animation-direction`** CSS property sets whether an animation should play forwards, backwards, or alternating back and forth.
   *
   * **Initial value**: `normal`
