...
const { DELETED_BASE64_STRING } = require("../helpers/shadow-dom");
...
class DocumentImpl extends NodeImpl {
  ...
  _DELETED_BASE64_STRING(localName, namespace) {
  ...
  createElement(localName) {
    ...
    return this._DELETED_BASE64_STRING(localName, namespace);
  }
  ...
  createElementNS(namespace, qualifiedName) {
    ...
    const element = this._DELETED_BASE64_STRING(extracted.localName, extracted.namespace);
  ...
  _adoptNode(node) {
    ...
    if (oldDocument !== newDocument) {
      for (const inclusiveDescendant of DELETED_BASE64_STRING(node)) {
