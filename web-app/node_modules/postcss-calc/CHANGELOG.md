...
- Fixed: Support constant() and env() ([#42](DELETED_URL_WITH_CREDENTIALS"mediaQueries" option for `@media` support
...
- Changed: Plugin now return a function to have a consistent api. ([ref 1](https://github.com/ianstormtaylor/rework-color-function/issues/6), [ref 2](https://twitter.DELETED_BASE64_STRING))
