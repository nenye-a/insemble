...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- CSS Dependencies -->
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-DELETED_BASE64_STRING" crossorigin="anonymous">
        <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-DELETED_BASE64_STRING" crossorigin="anonymous">
        <link rel="stylesheet" href="css/shards.min.css?version=2.1.2">
        <link rel="stylesheet" href="css/shards-extras.min.css?version=2.1.2">
    </head>
    <body class="shards-landing-page--1">
      ...
      <script src="https://code.jquery.com/jquery-3.2.1.min.js" integrity="sha256-DELETED_BASE64_STRING" crossorigin="anonymous"></script>
      <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-DELETED_BASE64_STRING" crossorigin="anonymous"></script>
      <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-DELETED_BASE64_STRING" crossorigin="anonymous"></script>
    </body>
</html>
